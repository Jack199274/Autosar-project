...
#define EEP_AR_RELEASE_MINOR_VERSION_CFG_C       3
#define EEP_AR_RELEASE_REVISION_VERSION_CFG_C    1
...
[!IF "ecu:get('Eep.HTChip')='true'"!]
        [!CALL "EepDemEventCfg","EepDemEventName"="'EEP_E_MGSTAT_BLOCK'","EepDelimiter"="','"!][!//
[!ENDIF!]
