...
#define ESYS_FLASHC_SW_PATCH_VERSION                    2
...
#if (ESYS_FLASHC_VENDOR_ID != EEP_VENDOR_ID_CFG)
    #error "Reg_eSys_Ftfc.h and Eep_Cfg.h have different vendor ids"
#endif
/* Check if current file and Eep_InternalTypes header file are of the same Autosar version */
#if ((ESYS_FLASHC_AR_RELEASE_MAJOR_VERSION    != EEP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (ESYS_FLASHC_AR_RELEASE_MINOR_VERSION    != EEP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (ESYS_FLASHC_AR_RELEASE_REVISION_VERSION != EEP_AR_RELEASE_REVISION_VERSION_CFG) \
    )
    #error "AutoSar Version Numbers of Reg_eSys_Ftfc.h and Eep_Cfg.h are different"
#endif
/* Check if current file and Eep_InternalTypes header file are of the same Software version */
#if ((ESYS_FLASHC_SW_MAJOR_VERSION != EEP_SW_MAJOR_VERSION_CFG) || \
     (ESYS_FLASHC_SW_MINOR_VERSION != EEP_SW_MINOR_VERSION_CFG) || \
     (ESYS_FLASHC_SW_PATCH_VERSION != EEP_SW_PATCH_VERSION_CFG) \
    )
    #error "Software Version Numbers of Reg_eSys_Ftfc.h and Eep_Cfg.h are different"
#endif
...
#define EEPROM_FDPROT_ADDR32    ((uint32)(FTFE_BASEADDR + (uint32)0x17UL)) /**< @brief Data Eeprom Protection Register (FTFE_FDPROT) */
    ...
    #define EEPROM_FCSESTAT1_ADDR32  ((uint32)(FTFE_BASEADDR + (uint32)0x2CUL))  /**< @brief Eeprom CSE Status Register 1 (FTFE_FCSESTAT1) */
    #define EEPROM_FCSESTAT0_ADDR32  ((uint32)(FTFE_BASEADDR + (uint32)0x2DUL))  /**< @brief Eeprom CSE Status Register 0 (FTFE_FCSESTAT0) */
#else
 ...
 */
#if (EEP_HTCHIP == STD_ON)
    #define EEPROM_FSTAT_MGSTAT0_U8      (0x01U) /**< @brief Memory Controller Command Completion Status 0 Flag */
    #define EEPROM_FSTAT_MGSTAT1_U8      (0x02U) /**< @brief Memory Controller Command Completion Status 1 Flag */
    #define EEPROM_FSTAT_MGSTAT2_U8      (0x04U) /**< @brief Memory Controller Command Completion Status 2 Flag */
    #define EEPROM_FSTAT_MGSTAT3_U8      (0x08U) /**< @brief Memory Controller Command Completion Status 3 Flag */
#else
 ...
 */
#if (EEP_HTCHIP == STD_ON)
    #define EEPROM_FERSTAT_PDFDIF_U8     (0x01U) /**< @brief Platform FlexRAM Double Bit Fault Detect Interrupt Flag */
    #define EEPROM_FERSTAT_DFDIF_U8      (0x02U) /**< @brief Platform Flash Double Bit Fault Detect Interrupt Flag */
    #define EEPROM_FERSTAT_EDFDIF_U8     (0x03U) /**< @brief Controller FlexRAM Double Bit Fault Detect Interrupt Flag Flag */
    #define EEPROM_FERSTAT_CDFDIF_U8     (0x04U) /**< @brief Controller Flash Double Bit Fault Detect Interrupt Flag */

    /* FERSTAT mask for  W1C operations */
    #define EEPROM_FERSTAT_PDFDIF_W1C    (EEPROM_FERSTAT_PDFDIF_U8)
    #define EEPROM_FERSTAT_DFDIF_W1C     (EEPROM_FERSTAT_DFDIF_U8)
    #define EEPROM_FERSTAT_EDFDIF_W1C    (EEPROM_FERSTAT_EDFDIF_U8)
    #define EEPROM_FERSTAT_CDFDIF_W1C    (EEPROM_FERSTAT_CDFDIF_U8)
#else
 ...
 */
#if (EEP_HTCHIP == STD_ON)
    #define EEPROM_FERCNFG_PDFDIE_U8     (0x01) /**< @brief Platform FlexRAM Double Bit Fault Detect Interrupt Enable */
    #define EEPROM_FERCNFG_DFDIE_U8      (0x02) /**< @brief Platform Flash Double Bit Fault Detect Interrupt Enable */
    #define EEPROM_FERCNFG_EDFDIE_U8     (0x04) /**< @brief Controller FlexRAM Double Bit Fault Detect Interrupt Enable */
    #define EEPROM_FERCNFG_CDFDIE_U8     (0x08) /**< @brief Controller Flash Double Bit Fault Detect Interrupt Enable */
    #define EEPROM_FERCNFG_PFDFD_U8      (0x10) /**< @brief Platform FlexRAM Force Double Bit Fault Detect */
    #define EEPROM_FERCNFG_FDFD_U8       (0x20) /**< @brief Force Double Bit Fault Detect */
    #define EEPROM_FERCNFG_EFDFD_U8      (0x40) /**< @brief Controller FlexRAM Force Double Bit Fault Detect */
    #define EEPROM_FERCNFG_CFDFD_U8      (0x80) /**< @brief Controller Flash Force Double Bit Fault Detect */
#else
...
#if (EEP_HTCHIP == STD_ON)
/**
 * @brief Eeprom CSE Status Register 1 (FTFE_FCSESTAT1)
 */
    #define EEPROM_FCSESTAT1_BSY_U8         (0x01U) /**< @brief Busy Flag */
    #define EEPROM_FCSESTAT1_SB_U8          (0x02U) /**< @brief Secure Boot Flag */
    #define EEPROM_FCSESTAT1_BIN_U8         (0x04U) /**< @brief Secure Boot Initialization Flag */
    #define EEPROM_FCSESTAT1_BFN_U8         (0x08U) /**< @brief Secure Boot Finished Flag */
    #define EEPROM_FCSESTAT1_BOK_U8         (0x10U) /**< @brief Secure Boot OK Flag */
    #define EEPROM_FCSESTAT1_RIN_U8         (0x20U) /**< @brief Random Number Generator Initialized Flag */
    #define EEPROM_FCSESTAT1_EDB_U8         (0x40U) /**< @brief External Debug Flag */
    #define EEPROM_FCSESTAT1_IDB_U8         (0x80U) /**< @brief Internal Debug Flag */
    
/**
 * @brief Eeprom CSE Status Register 0 (FTFE_FCSESTAT0)
 */
    #define EEPROM_FCSESTAT0_CMDTYPE_U8     (0x02U) /**< @brief Command Type Flag */
    #define EEPROM_FCSESTAT0_MEMERR_U8      (0x04U) /**< @brief Memory Error Flag */
#else
/**
 * @brief Eeprom CSE Status Register (FTFE_FCSESTAT)
 */
    #define EEPROM_FCSESTAT_BSY_U8          (0x01U) /**< @brief Busy Flag */
    #define EEPROM_FCSESTAT_SB_U8           (0x02U) /**< @brief Secure Boot Flag */
    #define EEPROM_FCSESTAT_BIN_U8          (0x04U) /**< @brief Secure Boot Initialization Flag */
    #define EEPROM_FCSESTAT_BFN_U8          (0x08U) /**< @brief Secure Boot Finished Flag */
    #define EEPROM_FCSESTAT_BOK_U8          (0x10U) /**< @brief Secure Boot OK Flag */
    #define EEPROM_FCSESTAT_RIN_U8          (0x20U) /**< @brief Random Number Generator Initialized Flag */
    #define EEPROM_FCSESTAT_EDB_U8          (0x40U) /**< @brief External Debug Flag */
    #define EEPROM_FCSESTAT_IDB_U8          (0x80U) /**< @brief Internal Debug Flag */
#endif
