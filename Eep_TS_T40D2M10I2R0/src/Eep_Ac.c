...
#define EEP_AC_SW_PATCH_VERSION_C               2
...
extern VAR(Eep_LengthType, EEP_VAR) Eep_Eeprom_u32RemainingLengthAC;
#endif
...
void Eep_Eeprom_AccessCode(P2FUNC(void, EEP_CODE, CallBack)( void ), VAR(uint8, AUTOMATIC) u8PageSize )
{
    ...
    if( u8PageSize == EEP_PAGE_SIZE_4BYTES)
    {
        ...
        *pu32TempDest = *pu32TempSrc;
        ...
        Eep_Eeprom_u32RemainingLengthAC = Eep_Eeprom_u32RemainingLengthAC - EEP_PAGE_SIZE_4BYTES;
    ...
    else
    {
        ...
        while((Eep_Eeprom_u32RemainingLengthAC > 0) &&  (u8Alignment2 < EEP_PAGE_SIZE_4BYTES))
        {
            ...
            /* Update remaining size. */
            Eep_Eeprom_u32RemainingLengthAC = Eep_Eeprom_u32RemainingLengthAC - EEP_PAGE_SIZE_1BYTE;
