...
#define EEP_AR_RELEASE_MINOR_VERSION_CFG     3
#define EEP_AR_RELEASE_REVISION_VERSION_CFG  1
...
/* defines if the enable and disable check source aligned with halfword and word access */
#define EEP_DISABLE_CHECKING_ALIGNMENT          [!IF "NonAutosar/EepDisableCheckingAlignment"!](STD_ON) [!ELSE!] (STD_OFF) [!ENDIF!]
/* User mode support */
#define EEP_ENABLE_USER_MODE_SUPPORT            (STD_OFF)

/* If this is a HT chip derivative the FTFM specific registers will be used */
#define EEP_HTCHIP         ([!IF "ecu:get('Eep.HTChip')='true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
[!IF "ecu:get('Eep.HTChip')='true'"!]
     ...
     */    
    CONST(Mcal_DemErrorType, EEP_CONST) Eep_E_MGSTAT_BlockCfg;
[!ENDIF!]
[!ENDIF!][!//
    /** 
