...
[!IF "((ecu:get('PortPackage'))='Port_32QFN')"!][!//
    [!"$PinAbstractionModes_1"!][!//
[!ELSEIF "((ecu:get('PortPackage'))='Port_48LQFP')"!][!//
...
extern CONST(Port_ConfigType, PORT_CONST) Port_Config_[!"."!];[!CR!][!//
[!ENDCODE!][!//
    [!ENDLOOP!][!//
[!ELSE!][!//
[!CODE!][!//
/** @violates @ref PORT_CFG_H_REF_4 Objects shall be defined at block scope */
extern CONST(Port_ConfigType, PORT_CONST) Port_Config;[!CR!][!//
[!ENDCODE!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDIF!]
