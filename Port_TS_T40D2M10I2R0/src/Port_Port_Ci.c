...
#define PORT_PORT_CI_SW_PATCH_VERSION_C              2
...
/* Check if Port_Port_Ci.c and Reg_eSys_Gpio.h are of the same vendor */
    ...
    #error "Port_Port_Ci.c and Reg_eSys_Gpio.h have different vendor ids"
#endif
/* Check if Port_Port_Ci.c and Reg_eSys_Gpio.h are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Port_Port_Ci.c and Reg_eSys_Gpio.h are different"
#endif
/* Check if Port_Port_Ci.c and Reg_eSys_Gpio.h are of the same software version */
    ...
    #error "Software Version Numbers of Port_Port_Ci.c and Reg_eSys_Gpio.h are different"
#endif
