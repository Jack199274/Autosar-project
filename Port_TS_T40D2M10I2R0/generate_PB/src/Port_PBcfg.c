...
[!ELSEIF "((ecu:get('PortFamily'))=116)"!][!//
    [!INCLUDE "Port_S32K116_Resource.m"!][!//
[!ELSEIF "((ecu:get('PortFamily'))=string('142w'))"!][!//
    [!INCLUDE "Port_S32K142w_Resource.m"!][!//
[!ELSEIF "((ecu:get('PortFamily'))=string('144w'))"!][!//
...
[!ELSE!][!//
    ...
    [!VAR "MacUnusedPinMSCR"="bit:or($MacUnusedPinMSCR,bit:shl(0,8))"!][!//
[!ENDIF!][!//
    [!/* Check what type of drive strength is set.*/!][!//
    [!IF "text:match(./PortPinDSE,'Low_Drive_Strength')"!][!//
    ...
    [!IF "text:match(./PortPinPE,'PullEnabled')"!][!//
        ...
        [!ELSEIF "text:match(./PortPinPS,'PullDown')"!][!//
            [!VAR "MacUnusedPinMSCR"="bit:or($MacUnusedPinMSCR,bit:shl(0,0))"!][!//
        [!ENDIF!][!//
    [!ELSEIF "text:match(./PortPinPE,'PullDisabled')"!][!//
        [!VAR "MacUnusedPinMSCR"="bit:or($MacUnusedPinMSCR,bit:shl(0,1))"!][!//
    [!ENDIF!][!//
[!ENDNOCODE!][!//
...
[!ELSE!][!//
    ...
    [!IF "variant:size()>0"!][!//
        CONST(Port_ConfigType, PORT_CONST) Port_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
