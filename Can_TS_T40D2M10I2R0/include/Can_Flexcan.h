...
#define CAN_FLEXCAN_SW_PATCH_VERSION_H             2
...
/* Check if current file and Can.h file are of the same Software version */
    ...
    /* Check if current file and Can_GeneralTypes.h file are of the same Software version */
    #if ((CAN_FLEXCAN_AR_RELEASE_MAJOR_VERSION_H != CAN_GENERALTYPES_AR_RELEASE_MAJOR_VERSION) || \
        (CAN_FLEXCAN_AR_RELEASE_MINOR_VERSION_H != CAN_GENERALTYPES_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of FlexCan.h and Can_GeneralTypes.h are different"
    #endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
typedef struct
    {
        ...
        VAR(boolean, CAN_VAR) bTxGuard[96]; /*< @brief Guard bits for EXCLUSIVE ACCESS to Tx MBs */
        ...
        VAR(boolean, CAN_VAR) bTxGuard[64]; /*< @brief Guard bits for EXCLUSIVE ACCESS to Tx MBs */
        ...
        VAR(boolean, CAN_VAR) bTxGuard[32]; /*< @brief Guard bits for EXCLUSIVE ACCESS to Tx MBs */
        ...
        */
        #define CAN_RXFIFO_EVENTS(FC) \
            ISR(Can_IsrFC##FC##_RxFifoEvents) { \
                    ...
                    { \
                        Can_IPW_ProcessRx( CAN_FC##FC##_INDEX, FLEXCAN_FIFOFRAME_INT_INDEX_U8, FLEXCAN_FIFOOVERFLOW_INT_INDEX_U8); \
                    } \
                    EXIT_INTERRUPT(); \
            }
