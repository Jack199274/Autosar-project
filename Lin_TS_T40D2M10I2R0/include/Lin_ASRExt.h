...
*   @version 1.0.2
*
*   @brief   AUTOSAR Lin - Lin module AutosarExt API header.
*   @details Lin AutosarExt APIs and defines.
*
*   @addtogroup LIN
*   @{
*/
...
#define LIN_VENDOR_ID_ASREXT                    43
#define LIN_MODULE_ID_ASREXT                    82
#define LIN_AR_RELEASE_MAJOR_VERSION_ASREXT     4
#define LIN_AR_RELEASE_MINOR_VERSION_ASREXT     3
#define LIN_AR_RELEASE_REVISION_VERSION_ASREXT  1
#define LIN_SW_MAJOR_VERSION_ASREXT             1
#define LIN_SW_MINOR_VERSION_ASREXT             0
#define LIN_SW_PATCH_VERSION_ASREXT             2
...
==================================================================================================*/
    ...
    /**
    * @violates @ref Lin_ASRExt_h_REF_1 MISRA 2004 Required Rule 19.15, Repeated include file
    *
    *
    * @violates @ref Lin_ASRExt_h_REF_2 MISRA 2004 Advisory Rule 19.1, only preprocessor
...
/**
* @violates @ref Lin_ASRExt_h_REF_1 Precautions shall be taken in order to prevent the contents
