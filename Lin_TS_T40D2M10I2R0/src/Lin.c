...
#define LIN_SW_PATCH_VERSION_C               2
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
/* Check if current file and Lin_IPW header file are of the same Software version */
    ...
    #error "Software Version Numbers of Lin.c and Lin_IPW.h are different"
        ...
        #endif
    #endif
    /* Check if the source file and LinIf_Cbk header file are of the same Autosar version */
    #if ((LIN_AR_RELEASE_MAJOR_VERSION_C != LINIF_CBK_AR_RELEASE_MAJOR_VERSION) || \
         (LIN_AR_RELEASE_MINOR_VERSION_C != LINIF_CBK_AR_RELEASE_MINOR_VERSION) \
        )
...
*                          in sleep state or no wakeup has been detected.
* @retval E_OK             No error has occurred during execution of the API
*                          and wakeup has been detected.
*
* @api
*
...
FUNC(Std_ReturnType, LIN_CODE) Lin_CheckWakeup(VAR(uint8, AUTOMATIC) Channel)
{
    ...
    else
    {
        ...
        {
            u8LinChannelStatus = Lin_au8LinChStatus[Channel];
            ...
            {
                /* Lin channel is in LIN_CH_SLEEP_STATE state or LIN_CH_SLEEP_PENDING state */
                if ((uint8)STD_ON == Lin_pChannelConfigPtr[Channel]->pChannelConfigPC->u8LinChannelWakeupSupport)
                {
...
FUNC(Lin_StatusType, LIN_CODE) Lin_GetStatus(VAR(uint8, AUTOMATIC) Channel, P2P2VAR(uint8, AUTOMATIC, LIN_APPL_DATA) Lin_SduPtr)
{
    ...
    VAR(uint8, AUTOMATIC) u8Lin_ChannelState;
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                Lin_au8LinChFrameErrorStatus[Channel] = LIN_NO_ERROR;
                u8TempReturn = (uint8)E_OK;
            }
        }
    }
