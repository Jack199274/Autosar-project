...
#define LIN_SW_PATCH_VERSION_IRQ_C             2
...
/* Check if current file and Lin header file are of the same vendor */
    ...
    #error "Lin_LPUART_Irq.c and Lin.h have different vendor ids"
#endif
/* Check if current file and Lin.h header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Lin_LPUART_Irq.c and Lin.h are different"
#endif
/* Check if current file and Lin.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Lin_LPUART_Irq.c and Lin.h are different"
#endif
/* Check if current file and Lin_LPUART header file are of the same vendor */
#if (LIN_IRQ_VENDOR_ID_C != LIN_LPUART_VENDOR_ID)
    #error "Lin_LPUART_Irq.c and Lin_LPUART.h have different vendor ids"
#endif
/* Check if current file and Lin_LPUART header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Lin_LPUART_Irq.c and Lin_LPUART.h are different"
#endif
/* Check if current file and Lin_LPUART header file are of the same Software version */
     ...
     (LIN_SW_MINOR_VERSION_IRQ_C != LIN_LPUART_SW_MINOR_VERSION) || \
     (LIN_SW_PATCH_VERSION_IRQ_C != LIN_LPUART_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lin_LPUART_Irq.c and Lin_LPUART.h are different"
#endif
/*==================================================================================================
