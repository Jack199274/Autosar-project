...
* external identifiers.
*/
#define LIN_AR_RELEASE_MINOR_VERSION_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_C       3
/*
* @violates @ref Lin[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBcfg_c_REF_3 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define LIN_AR_RELEASE_REVISION_VERSION_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_C    1
...
#define LIN_SW_PATCH_VERSION_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_C               2
...
[!LOOP "LinGlobalConfig/LinChannel/*"!][!//
[!IF "contains(node:value(LinHwChannel),'FLEXIO')"!][!//
[!VAR "LinFlexIOChannel"= "'true'"!]
[!ELSE!][!//
[!VAR "LinFlexIOChannel"= "'false'"!]
[!ENDIF!][!//
/**
...
[!IF "$LinFlexIOChannel = 'true'"!][!//
    [!"$TIMCMPL"!]U,       /* Baudrate [!"LinChannelBaudRate"!] */
[!ELSE!][!//
...
[!NOCODE!][!//
    [!IF "$DualClockEnabled = 'true'"!]
        [!IF "node:exists(LinClockRef_Alternate)"!]
            ...
            [!CODE!]
            [!IF "$LinFlexIOChannel = 'true'"!][!//
                [!"$TIMCMPL"!]U,       /* Alternate Baudrate [!"LinChannelBaudRate"!] */
            [!ELSE!][!//
        ...
        [!ELSE!]
            [!CODE!]
            [!IF "$LinFlexIOChannel = 'true'"!][!//
                [!"$TIMCMPL"!]U,       /* This channel is not enable Alternate Mode, Set Alternate Baudrate is the same configuration as Normal Mode */
            [!ELSE!][!//
...
#endif
[!ENDCODE!]
[!IF "($LinFlexIOChannel = 'true') and ($LinFlexIOUsed = 'true')"!][!//
[!CODE!]
    &Lin_FlexIO_[!"node:name(.)"!]_PC,
[!ENDCODE!]
[!ELSEIF "($LinFlexIOChannel = 'false') and ($LinFlexIOUsed = 'true')"!][!//
[!CODE!]
    &Lin_FlexIO_Null_PC,
[!ENDCODE!]
[!ELSE!][!//
...
[!ELSE!]
CONST(Lin_ConfigType,LIN_CONST)  Lin_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
[!ENDIF!]
{
    {
[!ENDCODE!]
