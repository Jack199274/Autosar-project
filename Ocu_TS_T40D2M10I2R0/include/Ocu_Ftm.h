...
#define OCU_FTM_SW_PATCH_VERSION                2
/** @} */

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
#if (OCU_FTM_VENDOR_ID != OCU_FTM_TYPES_VENDOR_ID)
    #error "Ocu_Ftm.h and Ocu_Ftm_Types.h have different vendor ids"
#endif
/* Check if current file and Ocu_Types header file are of the same Autosar version */
#if (( OCU_FTM_AR_RELEASE_MAJOR_VERSION != OCU_FTM_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     ( OCU_FTM_AR_RELEASE_MINOR_VERSION != OCU_FTM_TYPES_AR_RELEASE_MINOR_VERSION) || \
     ( OCU_FTM_AR_RELEASE_REVISION_VERSION !=  OCU_FTM_TYPES_AR_RELEASE_REVISION_VERSION))
     #error "AutoSar Version Numbers of Ocu_Ftm.h and Ocu_Ftm_Types.h are different"
#endif
/* Check if current file and Ocu_Types header file are of the same software version */
#if ((OCU_FTM_SW_MAJOR_VERSION != OCU_FTM_TYPES_SW_MAJOR_VERSION) || \
     (OCU_FTM_SW_MINOR_VERSION != OCU_FTM_TYPES_SW_MINOR_VERSION) || \
     (OCU_FTM_SW_PATCH_VERSION != OCU_FTM_TYPES_SW_PATCH_VERSION))
     #error "Software Version Numbers of Ocu_Ftm.h and Ocu_Ftm_Types.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
