...
#define OCU_FTM_SW_PATCH_VERSION_C             2
/** @} */
...
/* Check if this source file and Std_Types.h file are of the same Autosar version */
 #if ((OCU_FTM_AR_RELEASE_MAJOR_VERSION_C != STD_AR_RELEASE_MAJOR_VERSION) || \
      (OCU_FTM_AR_RELEASE_MINOR_VERSION_C != STD_AR_RELEASE_MINOR_VERSION) \
     )
...
/* Check if the source file and Ocu header file are of the same Autosar version */
 ...
 #endif
 /* Check if the source file and Ocu header file are of the same Autosar version */
 #if ((OCU_FTM_AR_RELEASE_MAJOR_VERSION_C != SCHM_OCU_AR_RELEASE_MAJOR_VERSION) || \
     (OCU_FTM_AR_RELEASE_MINOR_VERSION_C != SCHM_OCU_AR_RELEASE_MINOR_VERSION) \
     )
 #error "AutoSar Version Numbers of Ocu_Ftm.c and SchM_Ocu.h are different"
 #endif
#endif
...
#define OCU_START_SEC_VAR_NO_INIT_16
...
#define OCU_STOP_SEC_VAR_NO_INIT_16
/*
* @violates @ref Ocu_Ftm_C_REF_1 Only preprocessor statements and comments before 'include'
*/
/*
...
)
{
    ...
    {
        Ocu_Ipw_ProcessCommonInterrupt((Ocu_ChannelType)u8ChannelsModOffset);
    }
}
