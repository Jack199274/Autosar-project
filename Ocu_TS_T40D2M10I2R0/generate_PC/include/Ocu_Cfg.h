...
#define OCU_CFG_AR_RELEASE_MINOR_VERSION          3
#define OCU_CFG_AR_RELEASE_REVISION_VERSION       1
...
==================================================================================================*/
    ...
    #error "Ocu_Cfg.h and Ocu_EnvCfg.h have different vendor ids"
#endif
/* Check if current file and Ocu_EnvCfg header file are of the same Autosar version */
     ...
     #error "AutoSar Version Numbers of Ocu_Cfg.h and Ocu_EnvCfg.h are different"
#endif
/* Check if current file and Ocu_EnvCfg header file are of the same software version */
     ...
     #error "Software Version Numbers of Ocu_Cfg.h and Ocu_EnvCfg.h are different"
#endif
...
#if (OCU_CFG_VENDOR_ID != OCU_TYPES_VENDOR_ID)
    #error "Ocu_Cfg.h and Ocu_Types.h have different vendor ids"
#endif
/* Check if current file and Ocu_Types header file are of the same Autosar version */
#if (( OCU_CFG_AR_RELEASE_MAJOR_VERSION != OCU_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     ( OCU_CFG_AR_RELEASE_MINOR_VERSION != OCU_TYPES_AR_RELEASE_MINOR_VERSION) || \
     ( OCU_CFG_AR_RELEASE_REVISION_VERSION !=  OCU_TYPES_AR_RELEASE_REVISION_VERSION))
     #error "AutoSar Version Numbers of Ocu_Cfg.h and Ocu_Types.h are different"
#endif
/* Check if current file and Ocu_Types header file are of the same software version */
#if ((OCU_CFG_SW_MAJOR_VERSION != OCU_TYPES_SW_MAJOR_VERSION) || \
     (OCU_CFG_SW_MINOR_VERSION != OCU_TYPES_SW_MINOR_VERSION) || \
     (OCU_CFG_SW_PATCH_VERSION != OCU_TYPES_SW_PATCH_VERSION))
     #error "Software Version Numbers of Ocu_Cfg.h and Ocu_Types.h are different"
#endif
...
[!FOR "ModuleIdx" = "0" TO "7"!]
    ...
    [!ENDLOOP!]
    [!IF "$ChannelIsrUsed = 'true'"!]
#define OCU_FTM_[!"$ModuleIdx"!]_USED
    [!ENDIF!]
[!ENDFOR!]
