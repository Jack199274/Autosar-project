...
[!IF "$x = AdcGroupId"!]
#define ADC_CFGSET_GROUP_[!"AdcGroupId"!]_CHANNELS      [!"num:i(count(AdcGroupDefinition/*))"!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDFOR!][!//
...
#include "Adc_MemMap.h"
    ...
    [!CALL "AdcExportDriverConfiguration"!]
...
[!IF "node:exists(AdcDemEventParameterRefs) and (AutosarExt/AdcDisableDemReportErrorStatus = 'false')"!][!//
