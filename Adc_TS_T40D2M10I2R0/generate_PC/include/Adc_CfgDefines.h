...
*/
#define ADC_NUM_SC1_N_REGISTER      [!"ecu:get('Adc.AdcConfigSet.AdcScRegister')"!]U
...
#define ADC_R_N_OFFSET_ADDR32      ([!"num:inttohex(num:i($RnOffSet))"!]UL)
...
*/
#define ADC_NUM_SC1_N_REGISTER_USED [!"ecu:get('Adc.AdcConfigSet.AdcScRegisterUsed')"!]U
/**
...
*/
#define ADC_ENABLE_DOUBLE_BUFFERING  [!IF "AutosarExt/AdcEnableDoubleBufferingOptimization"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!IF "AutosarExt/AdcEnableDmaTrasferMode  = 'true'"!][!//
/** 
* @brief           Active DMA.
*/
...
[!IF "node:exists(AdcDemEventParameterRefs)"!]
  [!IF "AutosarExt/AdcDisableDemReportErrorStatus = 'true'"!]
...
*/
#define ADC_BYPASS_CONSISTENCY_LOOP         [!IF "AutosarExt/AdcBypassConsistencyLoop"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
*/
#define ADC_HARDWARE_NORMAL_CONVERSIONS_USED       [!IF "AutosarExt/AdcUseHardwareNormalGroups"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
/** 
* @brief           AutosarExt symbolic names of channels on all HW units.
*/
/* ADC099 */
        ...
        [!IF "$Unit = substring-after(string(AdcHwUnitId),'ADC')"!][!//
            [!IF "'ADC_DMA' = string(AdcTransferType)"!][!//
                ...
                [!IF "($groupDBMO > 0) and ($groupDBMO < count(AdcGroup/*))"!][!//
                    [!LOOP "node:refs('ASPathDataOfSchema:/TS_T40D2M10I2R0/Mcl')/MclConfigSet/DMAChannel/*[MclDMAChannelEnable = 'true']"!][!//
