...
#define FLASH_FSTAT_MGSTAT1_U8      (0x0002U) /**< @brief Memory Controller Status Flag 1*/
#define FLASH_FSTAT_MGSTAT2_U8      (0x0003U) /**< @brief Memory Controller Status Flag 2*/
#define FLASH_FSTAT_MGSTAT3_U8      (0x0004U) /**< @brief Memory Controller Status Flag 3*/
