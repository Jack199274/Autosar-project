...
#define FLS_FLASH_SW_PATCH_VERSION_C               2
...
/* Check if current file and Fls_Flash_Types header file are of the same Software version */
    ...
    /* Check if current file and Det header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Fls_Flash.c and Det.h are different"
    #endif
#endif
#endif
    ...
    /* Check if current file and Mcl header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Fls_Flash.c and Mcl.h are different"
    #endif
#endif
#endif /* FLS_SYNCRONIZE_CACHE */
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and Det header file are of the same Autosar version */
    #if ((FLS_FLASH_AR_RELEASE_MAJOR_VERSION_C != SCHM_FLS_AR_RELEASE_MAJOR_VERSION) || \
         (FLS_FLASH_AR_RELEASE_MINOR_VERSION_C != SCHM_FLS_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Fls_Flash.c and SchM_Fls.h are different"
    #endif
#endif
    ...
    if(REG_BIT_GET8(FLASH_FSTAT_ADDR32,FLASH_FSTAT_CCIF_U8))
    {
        ...
        */
        if((0U == REG_BIT_GET8(FLASH_FSTAT_ADDR32,
                               ...
                               | FLASH_FSTAT_MGSTAT1_U8 | FLASH_FSTAT_MGSTAT2_U8 | FLASH_FSTAT_MGSTAT3_U8
                              )
           )
        #else
        /*
        ...
        */
        ...
        else /* errors encountered */
        {
            ...
            * and an integral type
            */
            if(0U != REG_BIT_GET8(FLASH_FSTAT_ADDR32, FLASH_FSTAT_MGSTAT1_U8 | FLASH_FSTAT_MGSTAT2_U8 | FLASH_FSTAT_MGSTAT3_U8))
            {
                (void) Det_ReportError( (uint16)FLS_MODULE_ID, FLS_INSTANCE_ID, FLS_MAINFUNCTION_ID, FLS_E_MGSTAT_ERRORS );
            }
            #endif
            #endif
            Fls_eLLDJob = FLASH_JOB_NONE;
...
)
{
    ...
    #if( (FLS_ERASE_BLANK_CHECK == STD_ON) ||  (STD_ON == FLS_SYNCRONIZE_CACHE) )
    u32PhysicalSectorSize = (*(Fls_pConfigPtr->paSectorSize))[ePhySector];
