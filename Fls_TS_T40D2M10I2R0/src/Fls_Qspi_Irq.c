...
#define FLS_QSPI_IRQ_SW_PATCH_VERSION_C               2
...
LOCAL_INLINE FUNC(Fls_LLDReturnType, FLS_CODE) Fls_Qspi_ProcessEraseJobIrq()
{
    VAR(Fls_LLDReturnType, AUTOMATIC) eRetVal = FLASH_E_OK;
...
LOCAL_INLINE FUNC(Fls_LLDReturnType, FLS_CODE) Fls_Qspi_ProcessWriteJobIrq()
{
    VAR(Fls_LLDReturnType, AUTOMATIC) eRetVal = FLASH_E_OK;
