...
[!/* This platform does not support Hyper flash, so FlsQspiHyperflashEnVar always is false. */!]
[!ENDNOCODE!][!//
...
[!IF "not(var:defined('FLS_CFG_GENERIC_MACROS_M4'))"!][!//
    ...
    [!MACRO "FlsCalcCrc"!][!//
        ...
        [[!IF "ecu:get('Fls.External.Qspi.Available') = 'STD_ON'"!]
                                    [!IF "../AutosarExt/FlsExternalSectorsConfigured"!]
...
[!MACRO "CheckPageSize"!][!//
[!NOCODE!][!//
[!IF "text:match(node:fallback(./FlsPhysicalSector, 'None'),'[E][X][T]')"!]
    [!IF "./FlsPageSize != 16"!]
        [!ERROR!] "Sector [!"./FlsPhysicalSector"!]. Page Size should be a multiple of 16 bytes for external sectors."[!ENDERROR!]
    [!ENDIF!]
[!ELSE!]
    [!IF "./FlsPageSize != 8"!]
        [!ERROR!] "Sector [!"./FlsPhysicalSector"!]. Page Size should be 8 for internal flash and can be chip specific for external memories."[!ENDERROR!][!//
    [!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
[!//
[!//
[!MACRO "CheckFlsSectorSize"!][!//
[!NOCODE!][!//
[!LOOP "node:order(FlsSectorList/FlsSector/*,'node:value(./FlsSectorIndex)')"!][!//
[!IF "text:contains(node:value(node:fallback( ./FlsPhysicalSector,'')),'FLS_EXT_')"!]
[!ELSE!]
[!VAR "Size" = "substring-before(text:grep(ecu:list('Fls.Sector.Physical.List'),concat('^[0-9a-zA-Z]+_', node:fallback(./FlsPhysicalSector, substring-after(ecu:list('Fls.Sector.Physical.List')[1], '_')),'.*'))[1],'_')"!]
[!VAR "Si" = "text:match(text:split($Size),'^[0-9]')"!]
    [!IF "text:match($Size,'^[0-9]') = 'true'"!]
        [!VAR "SizeSector" = "num:hextoint($Size)"!]
        [!IF "./FlsSectorSize != $SizeSector"!]
        [!ERROR!][!//
        "Size of this sector shall match size of the assigned physical sector [!"./FlsPhysicalSector"!], size of sector should be [!"num:hextoint($Size)"!]  bytes."[!//
        [!ENDERROR!][!//
        [!ENDIF!]
    [!ENDIF!]
[!ENDIF!]
...
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
[!MACRO "CheckFlsSectorStartaddress"!]
[!NOCODE!][!//
[!FOR "varcounter" = "0" TO "num:i(count(FlsSectorList/FlsSector/*)) - 1"!]
            [!FOR "varcounter1" = "1" TO "num:i(count(FlsSectorList/FlsSector/*))"!]
                [!VAR "FlsSectorStartaddressNext" = "num:i(node:value(concat('FlsSectorList/FlsSector/*[',$varcounter1,']/FlsSectorStartaddress')))"!]
                [!VAR "FlsSectorIndex" = "node:value(concat('FlsSectorList/FlsSector/*[',$varcounter1,']/FlsSectorIndex'))"!]
                [!IF "($FlsSectorIndex = $varcounter)"!]
                    [!IF " num:i($FlsSectorIndex) = 0"!]
                        [!IF "$FlsSectorStartaddressNext != 0"!]
                            [!ERROR!]
                                "Start address of sector index 0 must be 0."
                            [!ENDERROR!]
                        [!ENDIF!]
                    [!ELSE!]
                        [!IF " $FlsSectorStartaddressNext != $FlsSectorStartaddress + $FlsSectorSize"!]
                            [!ERROR!]
                                "Invalid start address of the sector [!"node:name(FlsSectorList/FlsSector/*[num:i($varcounter1)])"!]."
                            [!ENDERROR!]
                        [!ENDIF!]
                    [!ENDIF!]
                    [!VAR "FlsSectorSize" = "num:i(node:value(concat('FlsSectorList/FlsSector/*[',$varcounter1,']/FlsSectorSize')))"!]
                    [!VAR "FlsSectorStartaddress" = "num:i(node:value(concat('FlsSectorList/FlsSector/*[',$varcounter1,']/FlsSectorStartaddress')))"!]
                    [!BREAK!]
                [!ENDIF!]
            [!ENDFOR!]

    [!// Support for checking Fee driver.
    [!IF "node:exists(../../../../Fee/ELEMENTS/Fee)"!]
        [!FOR "feeClusterGroupCounter" = "1" TO "num:i(count(../../../../Fee/ELEMENTS/Fee/FeeClusterGroup/*))"!]
            [!FOR "feeClusterCounter" = "1" TO "num:i(count(../../../../Fee/ELEMENTS/Fee/FeeClusterGroup/*[num:i($feeClusterGroupCounter)]/FeeCluster/*))"!]
                [!FOR "feeSectorCounter" = "1" TO "num:i(count(count(../../../../Fee/ELEMENTS/Fee/FeeClusterGroup/*[num:i($feeClusterGroupCounter)]/FeeCluster/*[num:i($feeClusterCounter)]/FeeSector/*)))"!]
                    [!IF "text:split(node:value(../../../../Fee/ELEMENTS/Fee/FeeClusterGroup/*[num:i($feeClusterGroupCounter)]/FeeCluster/*[num:i($feeClusterCounter)]/FeeSector/*[num:i($feeSectorCounter)]/FeeSectorRef) ,'/')[6] = node:name(FlsSectorList/FlsSector/*[',$varcounter + 1,'])"!]
                        [!IF "(./../FlsGeneral/FlsCancelApi = 'true') and (./FlsSectorList/FlsSector/*[',$varcounter + 1,']/FlsPageWriteAsynch = 'true')"!]
                            [!ERROR!]"Incompatible FLS configuration. If the Fls_Cancel API is enabled in the FLS driver used by the FEE, the Fls Page Write Asynch mode cannot be used for flash sectors. Disable Fls_Cancel API, select different sector, or use synchronous write."[!ENDERROR!]
                        [!ENDIF!]
                    [!ENDIF!]
                [!ENDFOR!]
            [!ENDFOR!]
...
[!MACRO "FlsCheckOverlapSector"!]
        [!NOCODE!][!//
            [!SELECT "FlsSectorHwAddress"!]
                [!FOR "VarCounterFlsSector" = "1" TO "num:i(count(../../../FlsSector/*))"!]
                    [!VAR "FlsCurrentHwAdd" = "num:i(node:value(../../../FlsSector/*[num:i($VarCounterFlsSector)]/FlsSectorHwAddress))"!]
                    [!IF "text:contains(string(../../../FlsSector/*[num:i($VarCounterFlsSector)]/FlsPhysicalSector),'FLS_EXT_')"!]
                        [!FOR "VarCounterFlsSector1" = "1" TO "num:i(count(../../../FlsSector/*))"!]
                            [!IF "$VarCounterFlsSector1 = $VarCounterFlsSector"!]
                            [!ELSE!]
                                [!IF "text:contains(string(../../../FlsSector/*[num:i($VarCounterFlsSector1)]/FlsPhysicalSector),'FLS_EXT_')"!]
                                    [!VAR "FlsHwAdd" = "num:i(node:value(../../../FlsSector/*[num:i($VarCounterFlsSector1)]/FlsSectorHwAddress))"!]
                                    [!VAR "FlsSectorSize" = "num:i(node:value(../../../FlsSector/*[num:i($VarCounterFlsSector1)]/FlsSectorSize))"!]
                                    [!IF " (num:i($FlsCurrentHwAdd) < (num:i($FlsHwAdd) + num:i($FlsSectorSize))) and (num:i($FlsCurrentHwAdd) >= num:i($FlsHwAdd))"!]
                                        [!ERROR!]
                                            "[!"node:name(../../../FlsSector/*[num:i($VarCounterFlsSector)])"!] is overlap with [!"node:name(../../../FlsSector/*[num:i($VarCounterFlsSector1)])"!]. Please check Fls Sector Hardware Byte Address in [!"node:name(../../../FlsSector/*[num:i($VarCounterFlsSector)])"!]"
                                        [!ENDERROR!]
                                    [!ENDIF!]
                                [!ENDIF!]
                            [!ENDIF!]
...
[!ENDLOOP!][!//
    ...
    */
    ...
    {
    [!VAR "FlsLoopIt" = "count(FlsSectorList/FlsSector/*)"!][!//
    [!CALL "CheckFlsSectorSize"!][!//
    [!CALL "CheckFlsSectorStartaddress"!][!//
    [!LOOP "node:order(FlsSectorList/FlsSector/*,'node:value(./FlsSectorIndex)')"!][!//
        [!VAR "FlsLoopIt" = "$FlsLoopIt - 1"!][!//
    ...
    [!ENDLOOP!][!//
     ...
     /* aFlsSectorSize[] ([!"node:name(.)"!]) */
    static CONST(Fls_AddressType, FLS_CONST) [!"node:name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_aFlsSectorSize[[!"num:i(count(FlsSectorList/FlsSector/*))"!]] =
    {
    [!VAR "FlsLoopIt" = "count(FlsSectorList/FlsSector/*)"!][!//
    [!LOOP "node:order(FlsSectorList/FlsSector/*,'node:value(./FlsSectorIndex)')"!][!//
        [!VAR "FlsLoopIt" = "$FlsLoopIt - 1"!][!//
        [!WS "4"!](Fls_AddressType)[!"num:i(./FlsPhysicalSectorSize)"!]U[!IF "$FlsLoopIt != 0"!],[!ENDIF!] /* FlsSectorSize ([!"node:name(.)"!])*/
    [!ENDLOOP!][!//
    };

    /* FlsNumberOfSector[] ([!"node:name(.)"!]) */
    static CONST(uint16, FLS_CONST) [!"node:name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_aFlsNumberOfSector[[!"num:i(count(FlsSectorList/FlsSector/*))"!]] =
    {
    [!VAR "FlsLoopIt" = "count(FlsSectorList/FlsSector/*)"!][!//
    [!LOOP "node:order(FlsSectorList/FlsSector/*,'node:value(./FlsSectorIndex)')"!][!//
        [!VAR "FlsLoopIt" = "$FlsLoopIt - 1"!][!//
        [!WS "4"!][!"num:i(./FlsNumberOfSectors)"!]U[!IF "$FlsLoopIt != 0"!],[!ENDIF!] /* FlsNumberOfSector ([!"node:name(.)"!])*/
    [!ENDLOOP!][!//
    };

    /* aFlsSectorStartAddr[] ([!"node:name(.)"!]) */
    static CONST(Fls_AddressType, FLS_CONST) [!"node:name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_aFlsSectorStartAddr[[!"num:i(count(FlsSectorList/FlsSector/*))"!]] =
    {
    [!VAR "FlsLoopIt" = "count(FlsSectorList/FlsSector/*)"!][!//
    [!LOOP "node:order(FlsSectorList/FlsSector/*,'node:value(./FlsSectorIndex)')"!][!//
        [!VAR "FlsLoopIt" = "$FlsLoopIt - 1"!][!//
        [!WS "4"!](Fls_AddressType)[!"num:i(./FlsSectorStartaddress)"!]U[!IF "$FlsLoopIt != 0"!],[!ENDIF!] /* FlsSectorStartAddr ([!"node:name(.)"!])*/
    [!ENDLOOP!][!//
    };
    ...
    [!IF "num:i(count(FlsExternalDriver/FlsHwUnit/*)) != 0"!][!// /* If there is any QSPI hardware unit configured */        
        ...
        [!LOOP "FlsExternalDriver/FlsHwUnit/*"!][!//
            ...
            [!ENDIF!]
                ...
                [!WS "8"!](boolean)FALSE,             /*bQspiUnitWordAddressable*/
    ...
    */
    ...
    CONST( Fls_ConfigType, FLS_CONST) Fls_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
    [!ELSE!][!//
    ...
    [!ENDIF!][!//
    {
        ...
        [!WS "4"!]&[!"node:name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_aFlsSectorStartAddr,              /* (*paSectorStartAddr)[]  */
        [!WS "4"!]&[!"node:name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_aFlsSectorSize,                   /* (*paSectorSize)[]  */
        [!WS "4"!]&[!"node:name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_aFlsNumberOfSector,               /* (*paNumberOfSector)[]  */
