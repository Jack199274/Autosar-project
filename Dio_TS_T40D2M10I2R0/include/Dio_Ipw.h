...
#define DIO_SW_PATCH_VERSION_IPW            2
...
/* Check if Dio_Ipw.h and Dio_Reg_eSys_Gpio.h are of the same vendor */
#if (DIO_VENDOR_ID_IPW != DIO_REGESYS_GPIO_VENDOR_ID_REG)
    #error "VENDOR ID for Dio_Ipw.h and Dio_Reg_eSys_Gpio.h is different"
#endif
/* Check if Dio_Ipw.h and Dio_Reg_eSys_Gpio.h are of the same Autosar version */
#if ((DIO_AR_RELEASE_MAJOR_VERSION_IPW != DIO_REGESYS_GPIO_AR_RELEASE_MAJOR_VERSION_REG) || \
     (DIO_AR_RELEASE_MINOR_VERSION_IPW != DIO_REGESYS_GPIO_AR_RELEASE_MINOR_VERSION_REG) || \
     (DIO_AR_RELEASE_REVISION_VERSION_IPW != DIO_REGESYS_GPIO_AR_RELEASE_REVISION_VERSION_REG) \
    )
     #error "AUTOSAR Version Numbers of Dio_Ipw.h and Dio_Reg_eSys_Gpio.h are different"
#endif
/* Check if Dio_Ipw.h and Dio_Reg_eSys_Gpio.h are of the same software version */
#if ((DIO_SW_MAJOR_VERSION_IPW != DIO_REGESYS_GPIO_SW_MAJOR_VERSION_REG) || \
     (DIO_SW_MINOR_VERSION_IPW != DIO_REGESYS_GPIO_SW_MINOR_VERSION_REG) || \
     (DIO_SW_PATCH_VERSION_IPW != DIO_REGESYS_GPIO_SW_PATCH_VERSION_REG) \
    )
    #error "Software Version Numbers of Dio_Ipw.h and Dio_Reg_eSys_Gpio.h are different"
#endif
