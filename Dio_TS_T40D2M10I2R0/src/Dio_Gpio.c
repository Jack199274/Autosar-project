...
#define DIO_GPIO_SW_PATCH_VERSION_C             2
...
/* Dio_Gpio.h version check end */
    ...
    #if ((DIO_GPIO_AR_RELEASE_MAJOR_VERSION_C != SCHM_DIO_AR_RELEASE_MAJOR_VERSION) || \
         (DIO_GPIO_AR_RELEASE_MINOR_VERSION_C != SCHM_DIO_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AUTOSAR Version Numbers of Dio_Gpio.c and SchM_Dio.h are different"
    #endif
    /* SchM_Dio.h version check end */
#endif

/* Dio_Reg_eSys_Gpio.h version check start */
#if ((DIO_GPIO_AR_RELEASE_MAJOR_VERSION_C != DIO_REGESYS_GPIO_AR_RELEASE_MAJOR_VERSION_REG) || \
     (DIO_GPIO_AR_RELEASE_MINOR_VERSION_C != DIO_REGESYS_GPIO_AR_RELEASE_MINOR_VERSION_REG) || \
     (DIO_GPIO_AR_RELEASE_REVISION_VERSION_C != DIO_REGESYS_GPIO_AR_RELEASE_REVISION_VERSION_REG) \
    )
    #error "AUTOSAR Version Numbers of Dio_Gpio.c and Dio_Reg_eSys_Gpio.h are different"
#endif

#if ((DIO_GPIO_SW_MAJOR_VERSION_C != DIO_REGESYS_GPIO_SW_MAJOR_VERSION_REG) || \
     (DIO_GPIO_SW_MINOR_VERSION_C != DIO_REGESYS_GPIO_SW_MINOR_VERSION_REG) ||\
     (DIO_GPIO_SW_PATCH_VERSION_C != DIO_REGESYS_GPIO_SW_PATCH_VERSION_REG) \
    )
    #error "Software Version Numbers of Dio_Gpio.c and Dio_Reg_eSys_Gpio.h are different"
#endif

#if (DIO_GPIO_VENDOR_ID_C != DIO_REGESYS_GPIO_VENDOR_ID_REG)
    #error "VENDOR ID for Dio_Gpio.c and Dio_Reg_eSys_Gpio.h is different"
#endif
/* Dio_Reg_eSys_Gpio.h version check end */
