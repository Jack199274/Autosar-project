...
#define GPT_FTM_SW_PATCH_VERSION_C             2
/** @} */
...
==================================================================================================*/
    ...
    #if ((GPT_FTM_AR_RELEASE_MAJOR_VERSION_C != SCHM_GPT_AR_RELEASE_MAJOR_VERSION) || \
         (GPT_FTM_AR_RELEASE_MINOR_VERSION_C != SCHM_GPT_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Gpt_Ftm.c and SchM_Gpt.h are different"
    #endif
#endif
...
/* Check if source file and GPT header file are of the same Software version */
    ...
    /* Check if source file and SilRegMacros.h are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Gpt_Ftm.c and SilRegMacros.h are different"
    #endif
#endif
...
*/
#define GPT_FTM_OVERFLOW_PAD_U32           ((uint32)1U)

/**
* @brief Highest possible value for Ftm channels
*/
#define GPT_FTM_CNT_MAX_VALUE_U32          ((uint32)0xFFFFuL)
...
FUNC(void, GPT_CODE) Gpt_Ftm_ProcessCommonInterrupt(VAR(uint8, AUTOMATIC) u8HwChannel)
{
        ...
        (FTM_CSC_CHIE_ENABLE_U32 == u32Temp2))
    {
        ...
        if ((uint32)(u32OldCompare + u32TargetTime) > GPT_FTM_CNT_MAX_VALUE_U32)
        {
            /** @violates @ref GPT_FTM_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref GPT_FTM_C_REF_7 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            /** @violates @ref GPT_FTM_C_REF_6 MISRA 2004 Rule 10.1, Implicit conversion */
            REG_WRITE32(FTM_CV_ADDR32(u8ModuleIdx, u8ChannelIdx),  (uint32)(u32TargetTime - (GPT_FTM_CNT_MAX_VALUE_U32 - u32OldCompare)));
        }
        else
        {
            /** @violates @ref GPT_FTM_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
                                            ...
                                            VAR(uint32, AUTOMATIC) u32Value)
{
    ...
    if ((uint32)(u32CounterValue + u32Value) > GPT_FTM_CNT_MAX_VALUE_U32)
    {
        u32CompareValue = (uint32)(u32Value - (GPT_FTM_CNT_MAX_VALUE_U32 - u32CounterValue));
    }
    else
    {
                                                 ...
                                                 P2VAR(uint32, AUTOMATIC, GPT_APPL_DATA) pu32TargetValue)
{
    ...
    *pu32TargetValue = Gpt_Ftm_u32TargetValue[u8ModuleIdx][u8ChannelIdx];
    ...
    if (u32CounterValue > u32CompareValue)
    {
        ...
        if(((GPT_FTM_CNT_MAX_VALUE_U32 - u32CounterValue) + u32CompareValue) <= *pu32TargetValue)
        {
            /* New compare value was read by register read - isr served in time - we have roll-over */
            u32ReturnValue = (*pu32TargetValue - \
                            ((GPT_FTM_CNT_MAX_VALUE_U32 - u32CounterValue) + u32CompareValue)) + \
                            GPT_FTM_OVERFLOW_PAD_U32;
        }
        else
        {
