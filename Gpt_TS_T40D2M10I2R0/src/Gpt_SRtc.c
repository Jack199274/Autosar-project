...
#define GPT_SRTC_SW_PATCH_VERSION_C             2
...
==================================================================================================*/
    ...
    #if ((GPT_SRTC_AR_RELEASE_MAJOR_VERSION_C != SCHM_GPT_AR_RELEASE_MAJOR_VERSION) || \
         (GPT_SRTC_AR_RELEASE_MINOR_VERSION_C != SCHM_GPT_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Gpt_SRtc.c and SchM_Gpt.h are different"
    #endif
#endif
