...
#define GPT_LPTMR_SW_PATCH_VERSION_C             2
...
==================================================================================================*/
    ...
    #if ((GPT_LPTMR_AR_RELEASE_MAJOR_VERSION_C != SCHM_GPT_AR_RELEASE_MAJOR_VERSION) || \
         (GPT_LPTMR_AR_RELEASE_MINOR_VERSION_C != SCHM_GPT_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Gpt_Lptmr.c and SchM_Gpt.h are different"
    #endif
#endif
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if source file and Reg_eSys_Lptmr header file are of the same Autosar version */
                                   ...
                                   )
{
    ...
    /** @violates @ref GPT_LPTMR_C_REF_7 MISRA 2004 Rule 12.4, Side effects on right hand of logical operator: '||' or '&&'*/
...
*
* @param[in]  u8Prescaler      Prescaler value
* @param[in]  u8ClockSource    ClockSource value
*
*/
