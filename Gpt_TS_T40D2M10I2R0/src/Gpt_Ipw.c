...
FUNC (void, GPT_CODE) Gpt_Ipw_Init(P2CONST(Gpt_HwChannelConfigType, AUTOMATIC,GPT_APPL_CONST) pHwChannelConfig)
{
    ...
    switch(pHwChannelConfig->Gpt_uHwModule)
    {
        ...
        case GPT_LPIT_MODULE:
            ...
            pHwChannelConfig->Gpt_bChainMode,
#endif             
...
/*================================================================================================*/
#if(GPT_CHAIN_MODE == STD_ON)
FUNC (Std_ReturnType, GPT_CODE) Gpt_Ipw_EnableChainMode(P2CONST(Gpt_HwChannelConfigType, AUTOMATIC,GPT_APPL_CONST) pHwChannelConfig)
{
    VAR(Std_ReturnType,AUTOMATIC) returnValue = (Std_ReturnType)E_NOT_OK;
 
#if (GPT_LPIT_USED == STD_ON) 
    if((uint8)GPT_LPIT_MODULE == pHwChannelConfig->Gpt_uHwModule)
    {
        returnValue = Gpt_LPit_EnableChainMode(pHwChannelConfig->Gpt_uHwChannel);
    }
#endif
...
/*================================================================================================*/
#if(GPT_CHAIN_MODE == STD_ON)
FUNC (Std_ReturnType, GPT_CODE) Gpt_Ipw_DisableChainMode(P2CONST(Gpt_HwChannelConfigType, AUTOMATIC,GPT_APPL_CONST) pHwChannelConfig)
{
    VAR(Std_ReturnType,AUTOMATIC) returnValue = (Std_ReturnType)E_NOT_OK;
    ...
    if((uint8)GPT_LPIT_MODULE == pHwChannelConfig->Gpt_uHwModule)
    {
        returnValue = Gpt_LPit_DisableChainMode(pHwChannelConfig->Gpt_uHwChannel);
    }
#endif
...
* @param[in]     PredefTimer         Get value of PredefTimer
