...
#define GPT_LPIT_SW_PATCH_VERSION_C             2
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if this source file and SchM_Gpt.h file are of the same Autosar version */
    #if ((GPT_LPIT_AR_RELEASE_MAJOR_VERSION_C != SCHM_GPT_AR_RELEASE_MAJOR_VERSION) || \
         (GPT_LPIT_AR_RELEASE_MINOR_VERSION_C != SCHM_GPT_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Gpt_LPit.c and SchM_Gpt.h are different"
    #endif
#endif
...
#endif
/* Check if source file and Gpt_LPit header file are of the same Autosar version */
...
#endif
/* Check if source file and Gpt_LPit header file are of the same Software version */
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if source file and Reg_eSys_LPit header file are of the same Autosar version */
...
* @param[in]     bChainMode          indicates if the Chain mode is enabled
* @param[in]     uTimerTriggerConfig indicates if the Enable ext trigger is enabled
* @param[in]     bFreezeEnable       indicates if the Freeze mode is enabled
*/
FUNC(void, GPT_CODE) Gpt_LPit_Init(VAR(uint8, AUTOMATIC) u8HwChannel,
                                   #if(GPT_CHAIN_MODE == STD_ON)
                                   VAR(boolean, AUTOMATIC) bChainMode,
                                   #endif
                                   ...
                                   VAR(boolean, AUTOMATIC) bFreezeEnable)
{
...
#if (GPT_CHAIN_MODE == STD_ON)
    /* Check chain mode */
    if((boolean)TRUE == bChainMode)
    {
        /* Enable Chain Mode*/
        /** @violates @ref GPT_LPIT_C_REF_2 MISRA 2012  Required Rule 11.6, This macro computes the address
        *   of any register by using the hardware offset of the controller.*/
        /** @violates @ref GPT_LPIT_C_REF_5 MISRA 2012 Advisory Rule 11.4, The cast is used to access
        *   memory mapped registers.*/
        /** @violates @ref GPT_LPIT_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref GPT_LPIT_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/        
        REG_BIT_SET32(LPIT_TCTRL_ADDR32(u8ModuleIdx,u8ChannelIdx), (uint32)GPT_LPIT_TCTRL_CHAIN_MASK_U32);
    }
    else
    {
        /* Disable Chain Mode */
        ...
        *   memory mapped registers.*/
        /** @violates @ref GPT_LPIT_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref GPT_LPIT_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/         
        REG_BIT_CLEAR32(LPIT_TCTRL_ADDR32(u8ModuleIdx,u8ChannelIdx), (uint32)GPT_LPIT_TCTRL_CHAIN_MASK_U32);        
    }
#endif
    ...
    /** @violates @ref GPT_LPIT_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
    /** @violates @ref GPT_LPIT_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
    REG_BIT_SET32(LPIT_MCR_ADDR32((uint32)u8ModuleIdx), LPIT_MCR_DOZE_EN_MASK_U32);   
...
FUNC(void, GPT_CODE) Gpt_LPit_DeInit(VAR(uint8, AUTOMATIC) u8HwChannel)
{
    ...
    /* Disable Lpit in DOZE modes */
    /** @violates @ref GPT_LPIT_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
    /** @violates @ref GPT_LPIT_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
    REG_BIT_CLEAR32(LPIT_MCR_ADDR32((uint32)u8ModuleIdx), LPIT_MCR_DOZE_EN_MASK_U32); 
...
/*================================================================================================*/
#if (GPT_CHAIN_MODE == STD_ON)
FUNC(Std_ReturnType, GPT_CODE) Gpt_LPit_EnableChainMode(VAR(uint8, AUTOMATIC) u8HwChannel)
{
    VAR(Std_ReturnType,AUTOMATIC) returnValue = (Std_ReturnType)E_NOT_OK;
    VAR(uint8, AUTOMATIC) u8ModuleIdx  = (uint8)LPIT_MODULE_INDEX_U32(u8HwChannel);
    VAR(uint8, AUTOMATIC) u8ChannelIdx = (uint8)LPIT_CHANNEL_INDEX_U32(u8HwChannel);
    
    /* Can not enable chain mode for LPIT_CH_0 */
    if((uint8) 0x00 < u8ChannelIdx)
    {
        /* Enable Chain Mode*/
        /** @violates @ref GPT_LPIT_C_REF_2 MISRA 2012  Required Rule 11.6, This macro computes the address
        *   of any register by using the hardware offset of the controller.*/
...
/*================================================================================================*/
#if (GPT_CHAIN_MODE == STD_ON)
FUNC(Std_ReturnType, GPT_CODE) Gpt_LPit_DisableChainMode(VAR(uint8, AUTOMATIC) u8HwChannel)
{
    VAR(Std_ReturnType,AUTOMATIC) returnValue = (Std_ReturnType)E_NOT_OK;
    VAR(uint8, AUTOMATIC) u8ModuleIdx  = (uint8)LPIT_MODULE_INDEX_U32(u8HwChannel);
    VAR(uint8, AUTOMATIC) u8ChannelIdx = (uint8)LPIT_CHANNEL_INDEX_U32(u8HwChannel);

    /* Can not use chain mode for LPIT_CH_0 */
    if((uint8) 0x00 < u8ChannelIdx)
    {
        /* Disable Chain Mode*/
        /** @violates @ref GPT_LPIT_C_REF_2 MISRA 2012  Required Rule 11.6, This macro computes the address
