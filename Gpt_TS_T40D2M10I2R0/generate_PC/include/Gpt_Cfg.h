...
[!IF "node:exists(GptAutosarExt/GptStandbyWakeupSupport)"!][!//
...
*/
#define GPT_CHAIN_MODE ([!IF "GptAutosarExt/GptChainModeApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*
*/
#define GPT_LPIT_ENABLE_EXT_TRIGGERS     ([!IF "GptAutosarExt/GptEnableTriggers"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*
*/
#define GPT_STM_DEINIT_MODULE ([!IF "ecu:has('Gpt.Num_Stm_Hw_Modules')"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
