...
CONST(Wdg_ConfigType, WDG_CONST)Wdg_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
...
extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];
    [!ENDIF!][!//
    [!ENDLOOP!][!//
[!ENDMACRO!]
...
[!IF "var:defined('postBuildVariant')"!][!//
    ...
    [!//
        [!CODE!][!WS4!]extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_Config_[!"."!];[!IF "($variantIndex < $variantNumber) or ($num_confgIndex < $num_confg)"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS4!]extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_Config;[!CR!][!ENDCODE!]
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!]
