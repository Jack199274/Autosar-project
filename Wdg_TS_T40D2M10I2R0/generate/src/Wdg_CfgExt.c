  ...
  [!IF "variant:size()<=1"!]
      [!LOOP "WdgSettingsConfig/*"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
              ...
              [!CODE!][!WS "0"!]extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_Config_[!"$variant_name"!];[!CR!][!ENDCODE!]
          [!ELSE!][!//
              [!CODE!][!WS "0"!]extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_Config;[!CR!][!ENDCODE!]
          [!ENDIF!]
      [!ENDLOOP!][!//
...
[!IF "WdgGeneral/AutosarExt/WdgDisableDemReportErrorStatus = 'false'"!][!//
/** @violates @ref Wdg_Cfg_c_REF_4 MISRA 2004 Required Rule 8.10 External Linkage */
...
[!IF "WdgGeneral/AutosarExt/WdgDisableDemReportErrorStatus = 'false'"!][!//
/** @violates @ref Wdg_Cfg_c_REF_4 MISRA 2004 Required Rule 8.10 External Linkage */
CONST(Mcal_DemErrorType, WDG_CONST) Wdg_E_Timeout_Expired = 
{
[!IF "node:exists(WdgDemEventParameterRefs/WDG_E_TIMEOUT_EXPIRED)"!][!//
    (uint32)STD_ON,
[!ELSE!][!//
    (uint32)STD_OFF,
[!ENDIF!][!//
[!IF "node:exists(WdgDemEventParameterRefs/WDG_E_TIMEOUT_EXPIRED)"!][!//
    (uint16)DemConf_DemEventParameter_[!"node:ref(WdgDemEventParameterRefs/WDG_E_TIMEOUT_EXPIRED)/@name"!]
[!ELSE!][!//
    (uint16)0U
[!ENDIF!][!//
};
