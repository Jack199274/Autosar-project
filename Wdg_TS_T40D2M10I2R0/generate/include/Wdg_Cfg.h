...
[!IF "node:exists(WdgDemEventParameterRefs)"!]
      [!IF "WdgGeneral/AutosarExt/WdgDisableDemReportErrorStatus = 'true'"!]
...
[!IF "WdgGeneral/AutosarExt/WdgDisableDemReportErrorStatus = 'false'"!][!//
/*@violates @ref Wdg_Cfg_h_REF_3 MISRA Rule 8.7 Objects shall be defined at block scope if they are only accessed from within a single function */
extern CONST(Mcal_DemErrorType, WDG_CONST)Wdg_E_Timeout_Expired;
[!ENDIF!][!//
[!ENDIF!][!//
...
*/
#define WDG_RECONFIGURATION_TIMEOUT  ([!"num:i(WdgGeneral/WdgReconfigurationTimeout)"!]UL)
