...
#define WDG_WDOG_SW_PATCH_VERSION                2
...
#if (WDG_WDOG_VENDOR_ID != WDG_VENDOR_ID_CFG)
    #error "Wdg_Wdog.h and Wdg_Cfg.h have different vendor ids"
#endif
/* Check if current file and Wdg_Cfg header file are of the same Autosar version */
#if ((WDG_WDOG_AR_RELEASE_MAJOR_VERSION    != WDG_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (WDG_WDOG_AR_RELEASE_MINOR_VERSION    != WDG_AR_RELEASE_MINOR_VERSION_CFG) || \
     (WDG_WDOG_AR_RELEASE_REVISION_VERSION != WDG_AR_RELEASE_REVISION_VERSION_CFG) \
    )

    #error "AutoSar Version Numbers of Wdg_Wdog.h and Wdg_Cfg.h are different"
#endif
/* Check if current file and Wdg_Cfg header file are of the same Software version */
#if ((WDG_WDOG_SW_MAJOR_VERSION != WDG_SW_MAJOR_VERSION_CFG) || \
     (WDG_WDOG_SW_MINOR_VERSION != WDG_SW_MINOR_VERSION_CFG) || \
     (WDG_WDOG_SW_PATCH_VERSION != WDG_SW_PATCH_VERSION_CFG)    \
    )
    #error "Software Version Numbers of Wdg_Wdog.h and Wdg_Cfg.h are different"
#endif
/*==================================================================================================
*                                           CONSTANTS
==================================================================================================*/
