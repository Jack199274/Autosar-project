...
#define REG_ESYS_WDOG_DEFINES_SW_PATCH_VERSION             2
...
/**
* @brief This constant specifies the value of the WDOG_RCS's control bit. It will be set if the WDOG is reconfiguring.
*/
#define WDOG_REC_SUCCESS_U32                 (0x00000400UL)
