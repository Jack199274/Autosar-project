...
#define WDG_WDOG_SW_PATCH_VERSION_C              2
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((WDG_WDOG_AR_RELEASE_MAJOR_VERSION_C != SCHM_WDG_AR_RELEASE_MAJOR_VERSION) || \
         (WDG_WDOG_AR_RELEASE_MINOR_VERSION_C != SCHM_WDG_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Wdg_Wdog.c and SchM_Wdg.h are different"
    #endif
#endif
                                    ...
                                    )
{
    ...
    VAR(uint32, AUTOMATIC) u32TempRec = 0x00UL;
    ...
    if (0UL == u32Timeout)
    {
        ...
        if((uint32)STD_ON == Wdg_E_Timeout_Expired.state)
        {
            ...
            (void) Dem_SetEventStatus((Dem_EventIdType)Wdg_E_Timeout_Expired.id, DEM_EVENT_STATUS_FAILED);
        }
    #endif
    }
