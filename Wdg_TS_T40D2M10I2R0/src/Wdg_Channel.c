...
#define WDG_CHANNEL_SW_PATCH_VERSION_C               2

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Wdg_Channel header file are of the same vendor */
...
/* Check if current file and Wdg_Irq header file are of the same vendor */
    ...
    #error "Wdg_Channel.c and Wdg_Irq.h have different vendor ids"
#endif
...
/* Check if current file and SchM_Wdg header file are of the same version */
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
 ...
 * @retval      E_NOT_OK The function call is invalid
 *
 * @implements  Wdg_ChannelValidateConfigUpdate_Activity
 *
 * */
LOCAL_INLINE FUNC(Std_ReturnType, WDG_CODE) Wdg_ChannelValidateConfigUpdate(CONST(Wdg_IPW_InstanceType, WDG_CONST) Wdg_Instance)
{
