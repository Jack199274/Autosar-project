...
*/
#define  ICU_DMA_SIZE_U32           (DMA_SIZE_2BYTES)
/**
*    @brief Implementation specific.
*     DMA number of bytes transfer on a minor loop is 2 bytes - for 16 bits hw registers.
*/
#define  ICU_DMA_NUM_BYTES_U32      (2U)
/**
*    @brief Implementation specific.
*     DMA offset is 16 bits hw registers.
*/
#define  ICU_DMA_OFFSET_U32         (DMA_OFFSET_16_BITS)
/**
...
([!IF "IcuOptionalApis/IcuGetTimeElapsedApi"!][!IF "IcuOptionalApis/IcuSignalMeasurementApi"!]STD_ON[!ELSE!][!ERROR "If IcuSignalMeasurementApi == OFF this switch is shall also be set to OFF"!][!ENDIF!][!ELSE!]STD_OFF[!ENDIF!])
...
([!IF "IcuOptionalApis/IcuGetDutyCycleValuesApi"!][!IF "IcuOptionalApis/IcuSignalMeasurementApi"!]STD_ON[!ELSE!][!ERROR "If IcuSignalMeasurementApi == OFF this switch is shall also be set to OFF"!][!ENDIF!][!ELSE!]STD_OFF[!ENDIF!])
...
[!IF "node:exists(IcuNonAUTOSAR/IcuLptmrStandbyWakeupSupport)"!][!//
#define ICU_ASREXT_STANDBY_WAKEUP_SUPPORT    ([!IF "IcuNonAUTOSAR/IcuLptmrStandbyWakeupSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!ELSE!]
...
[!NOCODE!]
    [!VAR "NumIcuChannelsUsingPort"  = "0"!]
    [!LOOP "IcuConfigSet/IcuHwInterruptConfigList/*"!]
        [!IF "node:value(IcuIsrEnable)"!]
            [!IF "contains(IcuIsrHwId,'PORT')"!]
                [!VAR "NumIcuChannelsUsingPort" = "$NumIcuChannelsUsingPort + 1"!]
            [!ENDIF!]
        [!ENDIF!]
    [!ENDLOOP!]
    [!IF "num:i($NumIcuChannelsUsingPort)>0"!]
        [!CODE!]
...
[!CALL "ICU_CHECK_CHANNEL_VS_ISR_ENABLE"!]

[!IF "ecu:get('Icu.IcuConfig.Icu_PORT_ModuleSingleInterrupt') = 'FALSE'"!]
...
[!IF "var:defined('postBuildVariant')"!][!//
    ...
    [!//
        [!CODE!][!WS4!]extern CONST(Icu_ConfigType, ICU_CONST) Icu_Config_[!"."!];[!IF "$variantIndex < $variantNumber"!] \[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS4!]extern CONST(Icu_ConfigType, ICU_CONST) Icu_Config;[!CR!][!ENDCODE!]
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!]
