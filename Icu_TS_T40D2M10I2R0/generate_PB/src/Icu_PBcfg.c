...
#define ICU[!"$Icu_VS_Number"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    3
/*
 * @violates @ref Icu[!"$Icu_VS_Number"!]_PBCfg_c_4 Identifier clash
 */
#define ICU[!"$Icu_VS_Number"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C       1

#define ICU[!"$Icu_VS_Number"!]_PBCFG_SW_MAJOR_VERSION_C            1
#define ICU[!"$Icu_VS_Number"!]_PBCFG_SW_MINOR_VERSION_C            0
#define ICU[!"$Icu_VS_Number"!]_PBCFG_SW_PATCH_VERSION_C            2
...
[!ELSE!]
 CONST(Icu_ConfigType, ICU_CONST) Icu_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
[!ENDIF!]
{
