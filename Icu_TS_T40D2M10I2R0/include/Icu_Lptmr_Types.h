...
#define ICU_LPTMR_TYPES_SW_PATCH_VERSION                2
/**@}*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
    /* Check if header file and Reg_eSys_Lptmr header file are of the same Autosar version */
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((ICU_LPTMR_TYPES_AR_RELEASE_MAJOR_VERSION != REG_ESYS_LPTMR_AR_RELEASE_MAJOR_VERSION) || \
         (ICU_LPTMR_TYPES_AR_RELEASE_MINOR_VERSION != REG_ESYS_LPTMR_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Icu_Lptmr_Types.h and Reg_eSys_Lptmr.h are different"
    #endif
#endif
/*==================================================================================================
*                                          CONSTANTS
