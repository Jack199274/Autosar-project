...
#define ICU_PORT_CI_SW_PATCH_VERSION_C             2
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((ICU_PORT_CI_AR_RELEASE_MAJOR_VERSION_C != SCHM_ICU_AR_RELEASE_MAJOR_VERSION) || \
         (ICU_PORT_CI_AR_RELEASE_MINOR_VERSION_C != SCHM_ICU_AR_RELEASE_MINOR_VERSION))
            #error "AutoSar Version Numbers of Icu_Port_Ci.c and SchM_Icu.h are different"
    #endif
#endif
