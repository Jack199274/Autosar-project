...
#define ICU_LPTMR_SW_PATCH_VERSION_C             2
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((ICU_LPTMR_AR_RELEASE_MAJOR_VERSION_C != SCHM_ICU_AR_RELEASE_MAJOR_VERSION) || \
         (ICU_LPTMR_AR_RELEASE_MINOR_VERSION_C != SCHM_ICU_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Icu_Lptmr.c and SchM_Icu.h are different"
    #endif
#endif
