...
#include "m4_scst_compiler.h"
    ...
    SCST_EXPORT m4_scst_regbank_test2
...
SCST_SET(PRESIGNATURE, 0x28D6AF31)
    
    
    SCST_SECTION_EXEC(m4_scst_test_code_unprivileged)
    SCST_THUMB2

    /* The ".type" directive instructs the assembler/linker that the label "m4_scst_regbank_test2" designates a function.
    ...
    SCST_TYPE(m4_scst_regbank_test2, function)
m4_scst_regbank_test2:
    ...
    *   Rm   -  0x1
    *
    *   0x00000000 00000000 + 0x66666666*0x1 
    *
    *   Output:
    *   ------
    *   RdLo -  0x66666666
    *****************************************************/
    BL      m4_scst_regbank_test2_clear_registers
    LDR     R0,=VAL6    /* <Rn> */
    MOV     R1,#1       /* Rm */   
    ISB
    ...
    *****************************************************/ 
    ...
    B m4_scst_regbank_test2_ltorg_jump_1    /* jump over the following LTORG section */
    SCST_ALIGN_BYTES_4
...
m4_scst_regbank_test2_ltorg_jump_1:
    ...
    *   Rm   -  0x99999999
    *
    *   0x000000000 00000000 + 0x99999999*0x1 
    *
    *   Output:
    *   ------
    *   RdLo - 0x99999999 
    *****************************************************/
    ...
    B m4_scst_regbank_test2_ltorg_jump_2    /* jump over the following LTORG section */
    SCST_ALIGN_BYTES_4
    SCST_LTORG  /* Marks the current location for dumping psuedoinstruction pools (literal pool)
                   (containing numeric values for used symbolic names used within LDR instruction).
                   It is 4-byte aligned, as 2-byte alignment causes incorrect work. */
m4_scst_regbank_test2_ltorg_jump_2:
...
m4_scst_regbank_test2_clear_registers:
    MOV     R0,#0
    MOV     R1,#0
    MOV     R2,#0
    MOV     R3,#0
