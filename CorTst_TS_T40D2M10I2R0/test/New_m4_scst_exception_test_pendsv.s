...
#include "m4_scst_compiler.h"
    ...
    SCST_EXPORT m4_scst_exception_test_pendsv
    ...
    /* The ".type" directive instructs the assembler/linker that the label "m4_scst_exception_test_pendsv" designates a function.
    ...
    SCST_TYPE(m4_scst_exception_test_pendsv, function)
m4_scst_exception_test_pendsv:
    ...
    ADR.W   R4,m4_scst_exception_test_pendsv_ISR1
    ...
    MOV     R2,#0x0
    ADR.W   R0,m4_scst_exception_test_pendsv_ISR_ret_addr1
    ...
    BNE     m4_scst_exception_test_pendsv_pending_active
...
m4_scst_exception_test_pendsv_ISR_ret_addr1:
    B       m4_scst_exception_test_pendsv_ISR_ret_addr1
    
    
m4_scst_exception_test_pendsv_pending_active:
    LDR     R3,=m4_scst_test_was_interrupted
    STR     R3,[R3]
m4_scst_exception_test_pendsv_end:
...
m4_scst_exception_test_pendsv_ISR1:
    ...
    ADR.W   R3, m4_scst_exception_test_pendsv_end
    STR     R3,[SP,#24]
