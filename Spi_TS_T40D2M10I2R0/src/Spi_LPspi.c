...
#define SPI_SW_PATCH_VERSION_LPSPI_C                 2
    ...
    )
{
    ...
    */
    REG_WRITE32(LPSPI_CFGR1_ADDR32(LPspi_u8HWoffset), (LPspi_u32CFGR1 & LPSPI_CFGR1_RWBITS_MASK_U32));
    ...
    * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
    */
    REG_WRITE32(LPSPI_CR_ADDR32(LPspi_u8HWoffset), (LPSPI_CR_MEN_EN_U32 | LPSPI_CR_DBGEN_EN_U32) & LPSPI_CR_RWBITS_MASK_U32);
}
        ...
        if (0u != LPspi_u32IsrStatus)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
                    */
                    REG_WRITE32(LPspi_pDev->LPspi_u32TCRAddress, (LPspi_u32Cmd & LPSPI_TCR_RWBITS_MASK_U32));
                }
            }
        }
        else
    ...
    ) \
{
    ...
    */
    if(0u!=(LPspi_u32Cmd & LPSPI_TCR_CONT_EN_U32 & LPSPI_TCR_RWBITS_MASK_U32))
    {
        if((uint8)TRUE == LPspi_pDev->LPspi_FirstChannelOfJobFlag)
        {
            ...
            * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
            */
            REG_WRITE32(LPspi_pDev->LPspi_u32TCRAddress, (LPSPI_TCR_CONTC_EN_U32 & LPSPI_TCR_RWBITS_MASK_U32));
        ...
        else
        {
            ...
            * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
            */
            REG_WRITE32(LPspi_pDev->LPspi_u32TCRAddress, (LPspi_u32Cmd | LPSPI_TCR_CONTC_EN_U32) & LPSPI_TCR_RWBITS_MASK_U32);
        }
    ...
    * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
    */
    REG_WRITE32(LPSPI_BASEADDR2FCR_ADDR32(LPspi_pDev->LPspi_u32BaseAddress), (LPspi_u32FCR & LPSPI_FCR_RWBITS_MASK_U32));
    ...
    ) \
{
    ...
    if(SPI_DATA_ACCESSED_16 == LPspi_pcChannelAttributesConfig->u8DataAccessed)
    {
        LPspi_nFramesCount/=2u;
    }
    else if(SPI_DATA_ACCESSED_32 == LPspi_pcChannelAttributesConfig->u8DataAccessed)
    {
                    ...
                    */
                    ...
                    LPspi_pChannelAttrs->LPspi_u32TCR =
                        ...
                        */
                        Spi_pcSpiConfigPtr->pcAttributesConfig->pcLPspiChannelAttributesConfig[LPspi_ChannelId].u32CMD;
#endif
                    LPspi_pChannelAttrs->LPspi_u8DataAccessed =
                        /*
                        * @violates @ref Spi_LPspi_c_REF_6 Array indexing shall be the only allowed form of pointer arithmetic.
                        */
                        Spi_pcSpiConfigPtr->pcAttributesConfig->pcLPspiChannelAttributesConfig[LPspi_ChannelId].u8DataAccessed;
                } /* for (channels) */
...
)
{
    ...
    if(0u != LPspi_u32IsrStatusTX)
    {
        ...
        else
        {
            ...
            * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
            */
            REG_WRITE32(LPspi_u32TCRAddress, (LPspi_u32Cmd & LPSPI_TCR_RWBITS_MASK_U32));
        }
    }
    else
    {
...
)
{
    ...
    while((Spi_ChannelType)0 < Spi_LPspi_pSyncTransmitState->LPspi_ChannelsCountTX)
    {
        ...
        */
        ...
        Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedTX = LPspi_pcChannelAttributesCfgTX->u8DataAccessed;
        /* set TCR register */
        /**
        * @note The call is blocking till the HWUnit exits
        *       the running state.
        */
        if(0u != (Spi_LPspi_pSyncTransmitState->LPspi_u32Cmd & LPSPI_TCR_CONT_EN_U32 & LPSPI_TCR_RWBITS_MASK_U32))
        {
            if((uint8)TRUE == LPspi_FirstChannelOfJobFlag)
            {
                ...
                * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
                */
                REG_WRITE32(LPSPI_BASEADDR2TCR_ADDR32(LPspi_u32BaseAddress), (Spi_LPspi_pSyncTransmitState->LPspi_u32Cmd & LPSPI_TCR_RWBITS_MASK_U32));
                /*
                * @violates @ref Spi_LPspi_c_REF_3 A cast should not be performed between a pointer
                *     type and an integral type.
                */
                ...
                * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
                */
                REG_WRITE32(LPSPI_BASEADDR2TCR_ADDR32(LPspi_u32BaseAddress), (LPSPI_TCR_CONTC_EN_U32 & LPSPI_TCR_RWBITS_MASK_U32));
            }
            else
            {
                /*
                ...
                * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
                */
                REG_WRITE32(LPSPI_BASEADDR2TCR_ADDR32(LPspi_u32BaseAddress), ((Spi_LPspi_pSyncTransmitState->LPspi_u32Cmd | LPSPI_TCR_CONTC_EN_U32) & LPSPI_TCR_RWBITS_MASK_U32));
            }
        }
        else
        {
        ...
        Spi_LPspi_pSyncTransmitState->LPspi_LengthTX = LPspi_pChannelState->Length;
          ...
          if (SPI_DATA_ACCESSED_16 == LPspi_pcChannelAttributesCfgTX->u8DataAccessed)
        {
            Spi_LPspi_pSyncTransmitState->LPspi_LengthTX /= 2u;
        }
        else if (SPI_DATA_ACCESSED_32 == LPspi_pcChannelAttributesCfgTX->u8DataAccessed)
        {
        ...
        if((uint8)TRUE == LPspi_FirstChannelOfJobFlag)
        {
            ...
            */
            ...
            Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedRX = LPspi_pcChannelAttributesCfgRX->u8DataAccessed;
    ...
    )
{
    ...
    *(pcSequence->LPspi_pJobStatus) = SPI_BUSY;
    ...
    while ((Spi_ChannelType)0 < Spi_LPspi_pSyncTransmitState->LPspi_ChannelsCountTX)
    {
        ...
        Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedTX = LPspi_pChannelTX->LPspi_u8DataAccessed;
        /* set TCR register */
        /**
        * @note The call is blocking till the HWUnit exits
        *       the running state.
        */
        ...
        if(0u != (LPspi_u32Cmd & LPSPI_TCR_CONT_EN_U32 & LPSPI_TCR_RWBITS_MASK_U32))
        {
            ...
            * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
            */
            REG_WRITE32(LPSPI_BASEADDR2TCR_ADDR32(LPspi_u32BaseAddress), (LPspi_u32Cmd & LPSPI_TCR_RWBITS_MASK_U32));
            /*
            * @violates @ref Spi_LPspi_c_REF_3 A cast should not be performed between a pointer
            *     type and an integral type.
            */
        ...
        Spi_LPspi_pSyncTransmitState->LPspi_LengthTX = LPspi_pChannelTX->LPspi_pState->Length;
          ...
          if (SPI_DATA_ACCESSED_16 == LPspi_pChannelTX->LPspi_u8DataAccessed)
        {
            Spi_LPspi_pSyncTransmitState->LPspi_LengthTX /= 2u;
        }
        else if (SPI_DATA_ACCESSED_32 == LPspi_pChannelTX->LPspi_u8DataAccessed)
        {
            Spi_LPspi_pSyncTransmitState->LPspi_LengthTX /= 4u;
        }
        else
        ...
        if((uint8)TRUE == LPspi_FirstChannelOfJobFlag)
        {
            ...
            Spi_LPspi_pSyncTransmitState->LPspi_LengthRX = Spi_LPspi_pSyncTransmitState->LPspi_LengthTX;
            Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedRX = Spi_LPspi_pSyncTransmitState->LPspi_pChannelRX->LPspi_u8DataAccessed;
        }
        LPspi_s32Timeout = SPI_TIMEOUT_COUNTER;
        /* while there is still something to read or to write */
...
)
{
    ...
    VAR(uint32, AUTOMATIC) LPspi_u32BaseAddress = Spi_LPspi_pSyncTransmitState->LPspi_u32BaseAddress;
     ...
     VAR(uint32, AUTOMATIC) LPspi_u32TempXferData;
      P2CONST(uint16, AUTOMATIC, SPI_APPL_CONST) LPspi_pu16BufferFullTX;
    P2CONST(uint32, AUTOMATIC, SPI_APPL_CONST) LPspi_pu32BufferFullTX;
      VAR(uint8, AUTOMATIC) LPspi_u8DataAccessedTX = Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedTX;
    ...
    */
    ...
    if (
         ...
         (((LPspi_u32FSR & LPSPI_FSR_TXCOUNT_MASK_U32) + ((LPspi_u32FSR & LPSPI_FSR_RXCOUNT_MASK_U32) >> 16u)) < (SPI_FIFO_SIZE_LPSPI - 1u))
       )
    {
        ...
        {
            /* Read transmit data */
              if (SPI_DATA_ACCESSED_16 == LPspi_u8DataAccessedTX)
            {
                /*
            ...
            else if (SPI_DATA_ACCESSED_32 == LPspi_u8DataAccessedTX)
            {
                /*
                * @violates @ref Spi_LPspi_c_REF_4 A cast should not be performed between a 
                *       pointer to object type and a different pointer to object type.
...
)
{
    ...
    VAR(uint32, AUTOMATIC) LPspi_u32BaseAddress = Spi_LPspi_pSyncTransmitState->LPspi_u32BaseAddress;
    VAR(uint8, AUTOMATIC) LPspi_u8DataAccessedRX = Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedRX;
    ...
    if (0u < Spi_LPspi_pSyncTransmitState->LPspi_LengthRX)
    {
         ...
         */
         ...
         if (0u < (LPspi_u32FSR & LPSPI_FSR_RXCOUNT_MASK_U32))
         {
            ...
            {
                  if (SPI_DATA_ACCESSED_16 == LPspi_u8DataAccessedRX)
                {
                     /*
                ...
                else if (SPI_DATA_ACCESSED_32 == LPspi_u8DataAccessedRX)
                {
                    /*
                    * @violates @ref Spi_LPspi_c_REF_4 A cast should not be
                    * performed between a pointer
            ...
            if((Spi_LPspi_pSyncTransmitState->LPspi_LengthRX == 0u) && (Spi_LPspi_pSyncTransmitState->LPspi_ChannelsCountRX > 0u))
            {
                ...
                if(LPSPI_SYNCTRANSMIT == LPspi_u8Sync)
                {
                    ...
                    */
                    LPspi_pcChannelAttributesCfgRX = &Spi_pcSpiConfigPtr->pcAttributesConfig->pcLPspiChannelAttributesConfig[LPspi_ChannelRX];
                    Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedRX = LPspi_pcChannelAttributesCfgRX->u8DataAccessed;
                    LPspi_u8DataAccessedRX = Spi_LPspi_pSyncTransmitState->LPspi_u8DataAccessedRX;
                    /*
                    * @violates @ref Spi_LPspi_c_REF_6 Array indexing shall be the only allowed form of pointer arithmetic.
                    */
                    LPspi_pcChannelConfigRX = &Spi_pcSpiConfigPtr->pcChannelConfig[LPspi_ChannelRX];
        ...
        */
        ...
        if(
             ...
             (0u != (LPspi_u32TCR & LPSPI_TCR_CONT_EN_U32 & LPSPI_TCR_RWBITS_MASK_U32)) &&
             (0u == LPspi_u32FSR)
          )
        {
    ...
    if(SPI_SLAVE == LPspi_pDev->LPspi_pcHWUnitConfig->eSpiPhyUnitMode)
    {
        ...
        do
        {
            ...
            /* end the loop if timeout expired */
             if ((sint32)0 >= LPspi_s32Timeout)
            {
                /* If the timeout expired, so Spi still in running mode, it means that data is still being sent by master. 
                A DEM event error would be raise */
#if (SPI_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)/* Call Dem_SetEventStatus. */
                if ((uint32)STD_ON == Spi_pcSpiConfigPtr->Spi_E_Timeout_ErrorCfg.state)
                {
                    (void)Dem_SetEventStatus((Dem_EventIdType)Spi_pcSpiConfigPtr->Spi_E_Timeout_ErrorCfg.id, DEM_EVENT_STATUS_FAILED);
                }
                else
                {
                    /* Do nothing */
