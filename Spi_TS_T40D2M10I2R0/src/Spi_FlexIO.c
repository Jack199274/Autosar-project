...
#include "Dem.h"
#endif
#endif /* (STD_ON == SPI_ENABLE_FLEXIO) */
...
#define SPI_FLEXIO_SW_PATCH_VERSION_C                 2
...
#error "AutoSar Version Numbers of Spi_FlexIO.c and Spi_IPW.h are different"
    ...
    /* Check if Spi_FlexIO.c file and Reg_eSys_FlexIO.h file are of the same Autosar version */
    ...
    */
    ...
    while((Spi_ChannelType)0 < Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_ChannelsCountTX)
    {
        ...
        */
        ...
        Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedTX = Spi_FlexIO_pcChannelAttributesCfgTX->u32DataAccessed;
        Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u8SpiDataWidth = Spi_FlexIO_pcChannelAttributesCfgTX->u8SpiDataWidth;
        ...
        Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX = Spi_FlexIO_pChannelState->Length;
          ...
          if (SPI_FLEXIO_DATA_ACCESSED_16 == Spi_FlexIO_pcChannelAttributesCfgTX->u32DataAccessed)
        {
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX /= 2u;
        }
        else if (SPI_FLEXIO_DATA_ACCESSED_32 == Spi_FlexIO_pcChannelAttributesCfgTX->u32DataAccessed)
        {
        ...
        if((uint8)TRUE == Spi_FlexIO_u8FirstChannelOfJobFlag)
        {
            ...
            */
            ...
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedRX = Spi_FlexIO_pcChannelAttributesCfgRX->u32DataAccessed;
    ...
    )
{
    ...
    *(pcSequence->FlexIO_pJobStatus) = SPI_BUSY;
    ...
    while ((Spi_ChannelType)0 < Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_ChannelsCountTX)
    {
        ...
        Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedTX = FlexIO_pChannelTX->u32DataAccessed;
        Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u8SpiDataWidth = FlexIO_pChannelTX->u8SpiDataWidth;
        /* Update the channel attributions */        
        ...
        Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX = FlexIO_pChannelTX->FlexIO_pState->Length;
          ...
          if (SPI_FLEXIO_DATA_ACCESSED_16 == FlexIO_pChannelTX->u32DataAccessed)
        {
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX /= 2u;
        }
        else if (SPI_FLEXIO_DATA_ACCESSED_32 == FlexIO_pChannelTX->u32DataAccessed)
        {
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX /= 4u;
        }
        else
        ...
        if((uint8)TRUE == FlexIO_FirstChannelOfJobFlag)
        {
            ...
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthRX = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX;
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedRX = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_pChannelRX->u32DataAccessed;
        }
        if(SPI_FLEXIO_CPHA_TRAILING_U8 == Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u8CPHA)
        {
            Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_au32SHIFTCFG[Spi_FlexIO_u8Shifter_TX] |= SPI_FLEXIO_SHIFTCFG_CPHA0_U32; 
...
)
{
    ...
    P2CONST(uint32, AUTOMATIC, SPI_APPL_CONST) Spi_FlexIO_pu32BufferFullTX;
      VAR(uint32, AUTOMATIC) Spi_FlexIO_u32DataAccessedTX = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedTX;
    VAR(uint8, AUTOMATIC) Spi_FlexIO_u8SpiDataWidth = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u8SpiDataWidth;
    VAR(uint8, SPI_VAR) Spi_FlexIO_u8Shifter_TX = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u8Shifter_TX;
    ...
    else 
    {
     ...
     if (Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthTX > 0u)
     {
        ...
        {
            /* Read transmit data */
              if (SPI_FLEXIO_DATA_ACCESSED_16 == Spi_FlexIO_u32DataAccessedTX)
            {
                /*
            ...
            else if (SPI_FLEXIO_DATA_ACCESSED_32 == Spi_FlexIO_u32DataAccessedTX)
            {
                /*
        ...
        */
        ...
        {
            Spi_FlexIO_u32TempXferData = Spi_FlexIO_u32TempXferData << (32U - Spi_FlexIO_u8SpiDataWidth);
        }
        else
        {
            /* Do notthing */
...
)
{
    ...
    P2VAR(uint32, AUTOMATIC, SPI_APPL_DATA) Spi_FlexIO_pu32BufferFullRX;
      VAR(uint32, AUTOMATIC) Spi_FlexIO_u32DataAccessedRX = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedRX;
    /* @violates @ref Spi_FlexIO_c_REF_13 Violates MISRA 2004 Required Rule 10.1 , Prohibited Implicit Conversion: Non-constant argument to function, Implicit conversion of integer to smaller type */
    ...
    if (0u < Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthRX)
    {
           ...
           if (NULL_PTR == Spi_FlexIO_pBufferRX)
            ...
            {
                  if (SPI_FLEXIO_DATA_ACCESSED_16 == Spi_FlexIO_u32DataAccessedRX)
                {
                     /*
                ...
                else if (SPI_FLEXIO_DATA_ACCESSED_32 == Spi_FlexIO_u32DataAccessedRX)
                {
                    /*
                    * @violates @ref Spi_FlexIO_c_REF_4 A cast should not be
                    * performed between a pointer
            ...
            if((0u == Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_LengthRX) && (0u < Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_ChannelsCountRX))
            {
                ...
                if(SPI_FLEXIO_SYNCTRANSMIT == FlexIO_u8Sync)
                {
                    ...
                    */
                    Spi_FlexIO_pcChannelAttributesCfgRX = &Spi_pcSpiConfigPtr->pcAttributesConfig->pcFlexIOChannelAttributesConfig[Spi_FlexIO_ChannelRX];
                    Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedRX = Spi_FlexIO_pcChannelAttributesCfgRX->u32DataAccessed;
                    Spi_FlexIO_u32DataAccessedRX = Spi_FlexIO_pSyncTransmitState->Spi_FlexIO_u32DataAccessedRX;
                    /*
                    * @violates @ref Spi_FlexIO_c_REF_6 Array indexing shall be the only allowed form of pointer arithmetic.
                    */
                    Spi_FlexIO_pcChannelConfigRX = &Spi_pcSpiConfigPtr->pcChannelConfig[Spi_FlexIO_ChannelRX];
    ...
    
{
    ...
    {
          if (SPI_FLEXIO_DATA_ACCESSED_16 == Spi_FlexIO_pcChannelAttributesConfig->u32DataAccessed)
        {
        ...
        else if (SPI_FLEXIO_DATA_ACCESSED_32 == Spi_FlexIO_pcChannelAttributesConfig->u32DataAccessed)
        {
            /* overwrite the default src next offset */
...
) \
{
    ...
    */    
    ...
    {
        if (SPI_FLEXIO_DATA_ACCESSED_8 == Spi_FlexIO_pcChannelAttributesConfig->u32DataAccessed)
        {
            ...
            if (FlexIO_pcJobConfig->NumChannels <= (SPI_OPTIMIZED_CHANNEL_BUFFER_SIZE-FlexIO_ChannelsAttrCurrentIndex))
            {
                ...
                for (FlexIO_Channel = 0u; FlexIO_Channel < FlexIO_pcJobConfig->NumChannels; FlexIO_Channel++)
                {
                    ...
                    */
                    ...
                    FlexIO_pChannelAttrs->u32DataAccessed =
                        /*
                        * @violates @ref Spi_FlexIO_c_REF_6 Array indexing shall be the only allowed form of pointer arithmetic.
                        */
                        Spi_pcSpiConfigPtr->pcAttributesConfig->pcFlexIOChannelAttributesConfig[FlexIO_ChannelId].u32DataAccessed;
                    FlexIO_pChannelAttrs->u8SpiDataWidth =
                        /*
                        * @violates @ref Spi_FlexIO_c_REF_6 Array indexing shall be the only allowed form of pointer arithmetic.
                        */
                        Spi_pcSpiConfigPtr->pcAttributesConfig->pcFlexIOChannelAttributesConfig[FlexIO_ChannelId].u8SpiDataWidth;
    ...
    ) \
{
    ...
    */
    Spi_FlexIO_pcChannelAttributesConfig = &Spi_pcSpiConfigPtr->pcAttributesConfig->pcFlexIOChannelAttributesConfig[*(FlexIO_pDev->Spi_FlexIO_pcCurrentChannelIndexPointerTX)];
    VAR(uint8, AUTOMATIC) Spi_FlexIO_u8SpiDataWidth = Spi_FlexIO_pcChannelAttributesConfig->u8SpiDataWidth;
      P2CONST(uint16, AUTOMATIC, SPI_APPL_CONST) Spi_FlexIO_pu16BufferFullTX;
    P2CONST(uint32, AUTOMATIC, SPI_APPL_CONST) Spi_FlexIO_pu32BufferFullTX;
    ...
    if (NULL_PTR != Spi_FlexIO_pBufferTX)
    {
        ...
        */       
        ...
        else if( SPI_FLEXIO_DATA_ACCESSED_32 == Spi_FlexIO_pcChannelAttributesConfig->u32DataAccessed)
        {
            ...
            */            
            Spi_FlexIO_pu32BufferFullTX = (uint32 *) Spi_FlexIO_pBufferTX;
            Spi_FlexIO_u32BufferFullTX = (*Spi_FlexIO_pu32BufferFullTX);
            /*
            * @violates @ref Spi_FlexIO_c_REF_6 Array indexing shall be
            *       the only allowed form of pointer arithmetic.
            */
        ...
        {
            Spi_FlexIO_u32BufferFullTX = Spi_FlexIO_u32BufferFullTX << (32U - Spi_FlexIO_u8SpiDataWidth);
        }
        else
        {
            /* Do notthing */
    ...
    {
        Spi_FlexIO_u32BufferFullTX = FlexIO_pDev->Spi_FlexIO_u32TransmitDefaultData;
        /* Re-update data to get LSB/MSB tranfer */
        if (SPI_FLEXIO_MSB_U8 == FlexIO_pDev->Spi_FlexIO_u8LBF)
        {
            Spi_FlexIO_u32BufferFullTX = Spi_FlexIO_u32BufferFullTX << (32U - Spi_FlexIO_u8SpiDataWidth);
    ...
    ) \
{
    ...
    */
    ...
    if (0u != (Spi_FlexIO_pChannelState->u8Flags & ((uint8)SPI_CHANNEL_FLAG_TX_DEFAULT_U8)))
    {
        FlexIO_pDev->Spi_FlexIO_pCurrentTxBuffer = NULL_PTR;

        /* Integrate default transmit value in the command */
        FlexIO_pDev->Spi_FlexIO_u32TransmitDefaultData = Spi_FlexIO_pcChannelConfig->u32DefaultTransmitValue;
    }
    else
    {
    ...
    */
    ...
    /* Enable Rx Shifter interrupt */
    Mcl_Flexio_WriteShiftSien((uint8)(1u << Spi_FlexIO_u8Shifter_RX),(uint8)(1u << Spi_FlexIO_u8Shifter_RX));
    /* Enable Tx Shifter interrupt */
...
)
{
    ...
    /* Get address of Shifter RX */
    Spi_FlexIO_u8Shifter_TX = FlexIO_pDev->Spi_FlexIO_pcHWUnitConfig->u8spiFlexIO_TX;
    ...
    )
{
    ...
    /* Get address of Shifter TX/RX */
    Spi_FlexIO_u8Shifter_TX = FlexIO_pDev->Spi_FlexIO_pcHWUnitConfig->u8spiFlexIO_TX;
    Spi_FlexIO_u8Shifter_RX =  FlexIO_pDev->Spi_FlexIO_pcHWUnitConfig->u8spiFlexIO_RX;
    AsyncMode = FlexIO_pDev->Spi_FlexIO_AsyncMode;
    if (SPI_POLLING_MODE != AsyncMode)
    {
        if(SPI_MASTER == FlexIO_pDev->Spi_FlexIO_pcHWUnitConfig->eSpiPhyUnitMode)
        {
            ...
            * @violates @ref Spi_FlexIO_c_REF_12 A cast should not be performed between a pointer type and an integral type.
            */
            FlexIO_u32IsrStatusRX &= (uint32)Mcl_Flexio_ReadShiftSien((uint8)(1u << Spi_FlexIO_u8Shifter_RX));
        }
        else
        {
            #if (SPI_SLAVE_SUPPORT == STD_ON)
        ...
        if ((boolean)TRUE == FlexIO_pDev->Spi_FlexIO_bIsEndOfJob)
        {
            if((0u == FlexIO_pDev->Spi_FlexIO_ReceivedData) && (0u == FlexIO_pDev->Spi_FlexIO_RemainingChannelsRX))
            {
                if(SPI_JOB_OK != FlexIO_pDev->Spi_FlexIO_pcCurrentJob->pJobState->Result)
                {
                    ...
                    Mcl_Flexio_WriteShiftSien((uint8)(1u << Spi_FlexIO_u8Shifter_RX), SPI_FLEXIO_CLEAR_FLAG_U8);
                    /* Call back upper function to finish job or transfer nex job. */
                    Spi_JobTransferFinished(FlexIO_pDev->Spi_FlexIO_pcCurrentJob);
                }
                else
                {
     ...
     )
{
    ...
    if (NULL_PTR != Spi_pcSpiConfigPtr)
    {
        if (0u != Spi_FlexIO_u8ShifterMask)
        {
            if(0u == Spi_FlexIO_u8Offset)
            {
                ...
                Spi_FlexIO_IsrFifoRx(Spi_FlexIO_HWUNIT2FlexIO(FLEXIOSPI_0_HWUNIT)); 
    #endif       
#endif
            }
            else
            ...
            if(1u == Spi_FlexIO_u8Offset)
            {
                ...
                Spi_FlexIO_IsrFifoRx(Spi_FlexIO_HWUNIT2FlexIO(FLEXIOSPI_1_HWUNIT)); 
    #endif       
#endif
            }
            else
    ...
    /* Spurious interrupt. Clear Shifter flags, Shifter error and Timer flags has been cleared by Mcl driver. */
    else
    {
        if(FLEXIO_0_CH_0 == Spi_FlexIO_u8Offset)
        {
            Mcl_Flexio_ClearShiftStat((uint8)FLEXIO_SEL_0_1_MASK_U32);
        }
        else if(FLEXIO_0_CH_2 == Spi_FlexIO_u8Offset)
        {
            Mcl_Flexio_ClearShiftStat((uint8)FLEXIO_SEL_2_3_MASK_U32);
        }
        else
        {
            /* do nothing */
            ...
            if(1u == FlexIO_pDev->Spi_FlexIO_u8IsPollRequest)
            {
                if ((0u != FlexIO_pDev->Spi_FlexIO_u32IsPollRequestTX) || (0u != FlexIO_pDev->Spi_FlexIO_u32IsPollRequestRX))
                {
                    /* Emulate IRQ in PIO_FIFO mode */
                     Spi_FlexIO_IsrFifoRx(FlexIO_pDev); 
                }
                else
                {
                    /* Do nothing */
