...
#if (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_VENDOR_ID_C != SPI_VENDOR_ID)
    #error "Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Spi.h have different vendor ids"
#endif
/* Check if current file and SPI header file are of the same Autosar version */
#if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != SPI_AR_RELEASE_MAJOR_VERSION) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != SPI_AR_RELEASE_MINOR_VERSION) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != SPI_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Spi.h are different"
#endif
/* Check if current file and SPI header file are of the same Software version */
#if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C != SPI_SW_MAJOR_VERSION) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C != SPI_SW_MINOR_VERSION) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C != SPI_SW_PATCH_VERSION))
    #error "Software Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Spi.h are different"
#endif

/* Check if current file and Reg_eSys_LPspi.h file are of the same vendor */
#if (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_VENDOR_ID_C != REG_ESYS_LPSPI_VENDOR_ID_REGFLEX)
    #error "Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Reg_eSys_LPspi.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_LPspi.h file are of the same Autosar version */
#if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_LPSPI_AR_RELEASE_MAJOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_LPSPI_AR_RELEASE_MINOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_LPSPI_AR_RELEASE_REVISION_VERSION_REGFLEX))
    #error "AutoSar Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Reg_eSys_LPspi.h are different"
#endif
/* Check if current file and Reg_eSys_LPspi.h file are of the same Software version */
#if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C != REG_ESYS_LPSPI_SW_MAJOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C != REG_ESYS_LPSPI_SW_MINOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C != REG_ESYS_LPSPI_SW_PATCH_VERSION_REGFLEX))
    #error "Software Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Reg_eSys_LPspi.h are different"
#endif

/* Check if current file and Reg_eSys_FLEXIOSPI.h file are of the same vendor */
#if (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_VENDOR_ID_C != REG_ESYS_FLEXIOSPI_VENDOR_ID_REGFLEX)
    #error "Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Reg_eSys_FLEXIOSPI.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_FLEXIOSPI.h file are of the same Autosar version */
#if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_FLEXIOSPI_AR_RELEASE_MAJOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_FLEXIOSPI_AR_RELEASE_MINOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_FLEXIOSPI_AR_RELEASE_REVISION_VERSION_REGFLEX))
    #error "AutoSar Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Reg_eSys_FLEXIOSPI.h are different"
#endif
/* Check if current file and Reg_eSys_FLEXIOSPI.h file are of the same Software version */
#if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C != REG_ESYS_FLEXIOSPI_SW_MAJOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C != REG_ESYS_FLEXIOSPI_SW_MINOR_VERSION_REGFLEX) || \
     (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C != REG_ESYS_FLEXIOSPI_SW_PATCH_VERSION_REGFLEX))
    #error "Software Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Reg_eSys_FLEXIOSPI.h are different"
#endif
    ...
    #if ((SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != DEM_AR_RELEASE_MAJOR_VERSION) || \
        (SPI[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != DEM_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Spi[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Dem.h are different"
    #endif
...
[!MACRO "GenerateSlaveDeviceInfo_LPSPI"!]
    ...
    [!ELSEIF "SpiDataShiftEdge = 'TRAILING'"!][!WS "8"!]    LPSPI_TCR_CPHA_TRAILING_U32[!//
    [!ELSE!][!ERROR "Illegal value for SpiDataShiftEdge"!][!//
    [!ENDIF!] | (uint32)0u | [!IF "SpiByteSwap = 'TRUE'"!] LPSPI_TCR_BYSW_EN_U32 [!ELSE!] LPSPI_TCR_BYSW_DIS_U32 [!ENDIF!] ) & LPSPI_TCR_RWBITS_MASK_U32),
    [!IF "$DualClockSupport = 'true'"!][!//
    [!IF "$DualClockEnabled = 'true'"!][!//
        /* Alternate Mode */
                (uint32)(([!IF "SpiShiftClockIdleLevel = 'LOW'"!]LPSPI_TCR_CPOL_LOW_U32[!//
...
[!IF "(node:value(SpiAutosarExt/SpiAllowBigSizeCollections) = 'false')"!]
...
/* SpiChannelConfig_PB Channel Configuration of [!"name(.)"!]*/
static CONST(Spi_ChannelConfigType, SPI_CONST) SpiChannelConfig_PB[[!"num:i($count)"!]] =
{
...
[!CODE!][!//
/* SpiJobConfig_PB Job Configuration of [!"name(.)"!]*/
static CONST(Spi_JobConfigType, SPI_CONST) SpiJobConfig_PB[[!"num:i($count)"!]] =
{
[!ENDCODE!][!//
...
[!ENDCODE!][!//
        ...
        &SpiExternalDeviceAttrsPB[SPI_[!"name(.)"!]]
...
/* SpiSequenceConfig_PB Sequence Configuration of [!"name(.)"!]*/
static CONST(Spi_SequenceConfigType, SPI_CONST) SpiSequenceConfig_PB[[!"num:i($count)"!]] =
{
...
[!VAR "LoopVar"="0"!][!//
[!VAR "count" = "count(SpiDriver/SpiChannel/*)"!][!//
/* LPspiChannelAttributesConfig_PB Channel Attribute Configuration of [!"name(.)"!]*/
/*
...
*/
static CONST(Spi_Ipw_LPspiChannelAttributesConfigType, SPI_CONST) LPspiChannelAttributesConfig_PB[[!"num:i($count)"!]] =
{
[!FOR "x" = "0" TO "num:i(count(SpiDriver/SpiChannel/*))"!][!//
[!LOOP "SpiDriver/SpiChannel/*"!][!//
[!VAR "Loop"="num:i($LoopVar)"!][!//
...
[!ELSEIF "(num:i(SpiDataWidth) > 8) and (num:i(SpiDataWidth) <= 16)"!][!//
    SPI_DATA_ACCESSED_16
[!ELSEIF "num:i(SpiDataWidth) > 16"!][!//
    SPI_DATA_ACCESSED_32
[!ENDIF!][!//
}[!//
[!IF "$idx!=$count"!],[!ENDIF!]
[!VAR "idx" = "$idx + 1"!][!//
...
[!VAR "LoopVar"="0"!][!//
[!VAR "count" = "count(SpiDriver/SpiChannel/*)"!][!//
/* FlexIOChannelAttributesConfig_PB Channel Attribute Configuration of [!"name(.)"!]*/
/*
* @violates @ref Spi_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_3 The compiler/linker shall be checked to ensure that 31 character
* signifiance and case sensitivity are supported for external identifiers.
*/
static CONST(Spi_Ipw_FlexIOChannelAttributesConfigType, SPI_CONST) FlexIOChannelAttributesConfig_PB[[!"num:i($count)"!]] =
{
[!FOR "x" = "0" TO "num:i(count(SpiDriver/SpiChannel/*))"!][!//
[!LOOP "SpiDriver/SpiChannel/*"!][!//
[!VAR "Loop"="num:i($LoopVar)"!][!//
...
{ 
    ...
    /* Data access */
[!IF "num:i(SpiDataWidth) <= 8"!][!//
    (uint32)SPI_FLEXIO_DATA_ACCESSED_8,
    [!ELSEIF "(num:i(SpiDataWidth) > 8) and (num:i(SpiDataWidth) <= 16)"!][!//
    (uint32)SPI_FLEXIO_DATA_ACCESSED_16,
    [!ELSEIF "num:i(SpiDataWidth) > 16"!][!//
    (uint32)SPI_FLEXIO_DATA_ACCESSED_32,
[!ENDIF!][!//
    /* Data Width */
    (uint8)[!"num:i(SpiDataWidth)"!]U
}
[!IF "$idx!=$count"!],[!ENDIF!]
[!VAR "idx" = "$idx + 1"!][!//
[!ENDIF!][!//
...
[!VAR "spiPath" = "node:path(.)"!][!//
/* LPspiDeviceAttributesConfig_PB Device Attribute Configuration of [!"name(.)"!]*/
static VAR(Spi_Ipw_LPspiDeviceAttributesConfigType, SPI_VAR) LPspiDeviceAttributesConfig_PB[[!"num:i($Number_LPspi)"!]] =
{
...
[!VAR "spiPath" = "node:path(.)"!][!//
/* FlexIODeviceAttributesConfig_PB Device Attribute Configuration of [!"name(.)"!]*/
static VAR(Spi_Ipw_FlexIODeviceAttributesConfigType, SPI_VAR) FlexIODeviceAttributesConfig_PB[[!"num:i($Number_FlexIO)"!]] =
{
[!AUTOSPACING!][!LOOP "SpiDriver/SpiExternalDevice/*"!][!//
        [!VAR "CSIB_number"="string(substring-after(node:value(SpiHwUnit),'CSIB')+1)"!][!//
...
/* DSpiDeviceAttributesConfig_PB Device Attribute Configuration of [!"name(.)"!]*/
static VAR(Spi_Ipw_DeviceAttributesConfigType, SPI_VAR) SpiExternalDeviceAttrsPB[[!"num:i(count(SpiDriver/SpiExternalDevice/*))"!]] =
{
[!AUTOSPACING!][!LOOP "SpiDriver/SpiExternalDevice/*"!][!//
        [!VAR "CSIB_number"="string(substring-after(node:value(SpiHwUnit),'CSIB')+1)"!]
        [!IF "contains((substring-before((node:value(concat($spiPath,'/SpiGeneral/SpiPhyUnit/*[',$CSIB_number,']/SpiPhyUnitMapping'))),'_')),'LPSPI')"!]
        {
        &LPspiDeviceAttributesConfigArray_PB[SPI_[!"name(.)"!]],
        NULL_PTR
        }[!IF "$deviceattribute>=$var"!],[!ENDIF!][!VAR "var"= "$var+1"!][!//
        [!ELSEIF "contains((substring-before((node:value(concat($spiPath,'/SpiGeneral/SpiPhyUnit/*[',$CSIB_number,']/SpiPhyUnitMapping'))),'_')),'FLEXIOSPI')"!]
        {
        NULL_PTR,
        &FlexIODeviceAttributesConfigArray_PB[SPI_[!"name(.)"!]]
        }[!IF "$deviceattribute>=$var"!],[!ENDIF!][!VAR "var"= "$var+1"!][!//
        [!ENDIF!][!//
[!CR!][!ENDLOOP!][!//
};
...
/* DeviceAttributesConfig_PB Device Attribute Configuration of [!"name(.)"!]*/
static P2CONST(Spi_Ipw_LPspiDeviceAttributesConfigType, SPI_VAR, SPI_APPL_CONST) LPspiDeviceAttributesConfigArray_PB[[!"num:i(count(SpiDriver/SpiExternalDevice/*))"!]] =
{
[!AUTOSPACING!][!LOOP "SpiDriver/SpiExternalDevice/*"!][!//
[!VAR "CSIB_number"="string(substring-after(node:value(SpiHwUnit),'CSIB')+1)"!][!//
        [!IF "contains((substring-before((node:value(concat($spiPath,'/SpiGeneral/SpiPhyUnit/*[',$CSIB_number,']/SpiPhyUnitMapping'))),'_')),'LPSPI')"!][!//
        &LPspiDeviceAttributesConfig_PB[[!"num:i($LPspi_Count)"!]][!IF "$deviceattribute>=$var"!],[!ENDIF!][!VAR "var"= "$var+1"!][!//
...
/* DeviceAttributesConfig_PB Device Attribute Configuration of [!"name(.)"!]*/
static P2CONST(Spi_Ipw_FlexIODeviceAttributesConfigType, SPI_VAR, SPI_APPL_CONST) FlexIODeviceAttributesConfigArray_PB[[!"num:i(count(SpiDriver/SpiExternalDevice/*))"!]] =
{
[!AUTOSPACING!][!LOOP "SpiDriver/SpiExternalDevice/*"!][!//
[!VAR "CSIB_number"="string(substring-after(node:value(SpiHwUnit),'CSIB')+1)"!][!//
        [!IF "contains((substring-before((node:value(concat($spiPath,'/SpiGeneral/SpiPhyUnit/*[',$CSIB_number,']/SpiPhyUnitMapping'))),'_')),'LPSPI')"!][!//
        NULL_PTR[!IF "$deviceattribute>=$var"!],[!ENDIF!][!VAR "var"= "$var+1"!][!//
        [!ELSEIF "contains((substring-before((node:value(concat($spiPath,'/SpiGeneral/SpiPhyUnit/*[',$CSIB_number,']/SpiPhyUnitMapping'))),'_')),'FLEXIOSPI')"!][!//
        &FlexIODeviceAttributesConfig_PB[[!"num:i($FlexIO_Count)"!]][!IF "$deviceattribute>=$var"!],[!ENDIF!][!VAR "var"= "$var+1"!][!//
...
[!CALL "Spi_CheckTypeOfIPV"!]
/* SpiAttributesConfig_PB Attribute Configuration of [!"@name"!] */
...
[!ENDIF!][!//
[!IF "$Exist_FLEXIO = 1"!][!//    
    FlexIOChannelAttributesConfig_PB,
[!ELSE!][!//
    NULL_PTR,
[!ENDIF!][!//
...
#if ((SPI_LEVEL_DELIVERED == LEVEL1) || (SPI_LEVEL_DELIVERED == LEVEL2))
#if (SPI_DMA_USED == STD_ON)
[!IF "ecu:get('SpiDMAPresent') = 'TRUE' and ../../SpiGlobalDmaEnable = 'true' and SpiPhyUnitAsyncMethod = 'DMA' and ../../SpiLevelDelivered >0"!][!//
    ,(uint16)TRUE
...
[!IF "(IMPLEMENTATION_CONFIG_VARIANT != 'VariantPostBuild' and (variant:size() <= 1))"!]Spi_PBCfgVariantPredefined[!//
[!ELSE!]Spi_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][!ENDIF!] =
{
...
[!ENDIF!][!//
[!IF "node:exists(SpiDemEventParameterRefs/SPI_E_TIMEOUT_ERROR)"!][!//
[!IF "node:exists(node:ref(SpiDemEventParameterRefs/SPI_E_TIMEOUT_ERROR))"!][!//
    ,{ (uint32)STD_ON, (uint32)DemConf_DemEventParameter_[!"node:name(node:ref(SpiDemEventParameterRefs/SPI_E_TIMEOUT_ERROR))"!]} /* SPI_E_TIMEOUT_ERROR parameters*/[!//
[!ELSE!][!//
    [!ERROR "Invalid reference for SPI_E_TIMEOUT_ERROR"!][!//
[!ENDIF!][!//
[!ELSE!][!//
...
[!IF "var:defined('postBuildVariant')"!][!//
    ...
    [!//
        [!CODE!][!WS4!]extern CONST(Spi_ConfigType, SPI_CONST) Spi_Config_[!"."!];[!IF "$variantIndex < $variantNumber"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS4!]extern CONST(Spi_ConfigType, SPI_CONST) Spi_Config;[!CR!][!ENDCODE!]
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
[!//==================================================================================================
