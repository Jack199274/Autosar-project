...
* Macros that are used in the code only in some configuration.
*/
#define REG_ESYS_FLEXIOSPI_SW_PATCH_VERSION_REGFLEX             2
...
* Macros that are used in the code only in some configuration. 
*/
#define SPI_FLEXIO_DATA_ACCESSED_8     ((uint32)15u) /* DataWidth = (15+1)/2 = 8  */
/*
* @violates @ref Spi_Cfg_h_REF_1 A project should not contain unused macro declarations.
* Macros that are used in the code only in some configuration. 
*/
#define SPI_FLEXIO_DATA_ACCESSED_16    ((uint32)31u) /* DataWidth = (31+1)/2 = 16 */
/*
* @violates @ref Spi_Cfg_h_REF_1 A project should not contain unused macro declarations.
* Macros that are used in the code only in some configuration. 
*/
#define SPI_FLEXIO_DATA_ACCESSED_32    ((uint32)63u) /* DataWidth = (63+1)/2 = 32 */
