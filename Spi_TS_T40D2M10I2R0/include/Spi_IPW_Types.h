...
#define SPI_IPW_TYPES_SW_PATCH_VERSION                2
...
typedef struct
{
    ...
    VAR(uint8, SPI_VAR)  u8DataAccessed;       /**< @brief Channel attributes for data width. */
...
typedef struct
{
    ...
    VAR(uint32, SPI_VAR) u32DataAccessed;       /**< @brief Channel attributes for data width. */
    VAR(uint8, SPI_VAR) u8SpiDataWidth;       /**< @brief The width of a transmitted data unit */
