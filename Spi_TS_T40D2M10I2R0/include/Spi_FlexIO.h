...
#define SPI_FLEXIO_SW_PATCH_VERSION             2
...
#if (SPI_FLEXIO_VENDOR_ID != REG_ESYS_FLEXIOSPI_VENDOR_ID_REGFLEX)
    #error "Spi_FlexIO.h and Reg_eSys_FlexIOSPI.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_FlexIOSPI header file are of the same Autosar version */
#if ((SPI_FLEXIO_AR_RELEASE_MAJOR_VERSION    != REG_ESYS_FLEXIOSPI_AR_RELEASE_MAJOR_VERSION_REGFLEX) || \
     (SPI_FLEXIO_AR_RELEASE_MINOR_VERSION    != REG_ESYS_FLEXIOSPI_AR_RELEASE_MINOR_VERSION_REGFLEX) || \
     (SPI_FLEXIO_AR_RELEASE_REVISION_VERSION != REG_ESYS_FLEXIOSPI_AR_RELEASE_REVISION_VERSION_REGFLEX))
    #error "AutoSar Version Numbers of Spi_FlexIO.h and Reg_eSys_FlexIOSPI.h are different"
#endif
/* Check if current file and Reg_eSys_FlexIOSPI header file are of the same Software version */
#if ((SPI_FLEXIO_SW_MAJOR_VERSION != REG_ESYS_FLEXIOSPI_SW_MAJOR_VERSION_REGFLEX) || \
     (SPI_FLEXIO_SW_MINOR_VERSION != REG_ESYS_FLEXIOSPI_SW_MINOR_VERSION_REGFLEX) || \
     (SPI_FLEXIO_SW_PATCH_VERSION != REG_ESYS_FLEXIOSPI_SW_PATCH_VERSION_REGFLEX))
    #error "Software Version Numbers of Spi_FlexIO.h and Reg_eSys_FlexIOSPI.h are different"
#endif
  ...
  #endif
  /* Check if the source file and Reg_eSys_FLEXIO header file are of the same version */
  #if ((SPI_FLEXIO_AR_RELEASE_MAJOR_VERSION != REG_ESYS_FLEXIO_AR_RELEASE_MAJOR_VERSION) || \
       (SPI_FLEXIO_AR_RELEASE_MINOR_VERSION != REG_ESYS_FLEXIO_AR_RELEASE_MINOR_VERSION))
      #error "AutoSar Version Numbers of Spi_FLexIO.h and Reg_eSys_FLEXIO.h are different"
  #endif
    /* Check if the source file and CDD_Mcl header file are of the same version */
  #if ((SPI_FLEXIO_AR_RELEASE_MAJOR_VERSION != MCL_AR_RELEASE_MAJOR_VERSION) || \
       (SPI_FLEXIO_AR_RELEASE_MINOR_VERSION != MCL_AR_RELEASE_MINOR_VERSION))
      #error "AutoSar Version Numbers of Spi_FLexIO.h and CDD_Mcl.h are different"
  #endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
typedef struct
{
    ...
    VAR(uint32, SPI_VAR) u32DataAccessed;
    /**< @brief The width of a transmitted data unit. */
    VAR(uint8, SPI_VAR) u8SpiDataWidth;
...
typedef struct
{
    ...
    VAR(uint32, SPI_VAR) Spi_FlexIO_u32DataAccessedTX;
    /**< @brief The data width value to be used for the data receive.*/
    VAR(uint32, SPI_VAR) Spi_FlexIO_u32DataAccessedRX;
    /**< @brief The width of a transmitted data unit. */
    VAR(uint8, SPI_VAR) Spi_FlexIO_u8SpiDataWidth;
