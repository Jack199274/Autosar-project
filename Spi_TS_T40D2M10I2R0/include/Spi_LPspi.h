...
#define SPI_SW_PATCH_VERSION_LPSPI             2
...
typedef struct
{
    ...
    VAR(uint8, SPI_VAR) LPspi_u8DataAccessed;
...
typedef struct
{
    ...
    VAR(uint8, SPI_VAR) LPspi_u8DataAccessedTX;
    /**< @brief The data width value to be used for the data receive.*/
    VAR(uint8, SPI_VAR) LPspi_u8DataAccessedRX;
