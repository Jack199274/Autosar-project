...
#define REG_ESYS_LPSPI_SW_PATCH_VERSION_REGFLEX             2
...
#define LPSPI_CR_RWBITS_MASK_U32        ((uint32)0x0000030Fu)
#define LPSPI_CFGR1_RWBITS_MASK_U32     ((uint32)0x0F070F0Fu)
#define LPSPI_FCR_RWBITS_MASK_U32       ((uint32)0x00030003u)
#define LPSPI_TCR_RWBITS_MASK_U32       ((uint32)0xFBFF0FFFu)
...
#define LPSPI_SR_DMF_W1C_U32              ((uint32)0x00002000u) /* Data Match Flag */
#define LPSPI_SR_REF_W1C_U32              ((uint32)0x00001000u) /* Receive Error Flag */
#define LPSPI_SR_TEF_W1C_U32              ((uint32)0x00000800u) /* Transmit Error Flag */
#define LPSPI_SR_TCF_W1C_U32              ((uint32)0x00000400u) /* Transfer Complete Flag */
#define LPSPI_SR_FCF_W1C_U32              ((uint32)0x00000200u) /* Frame Complete Flag */
#define LPSPI_SR_WCF_W1C_U32              ((uint32)0x00000100u) /* Word Complete Flag */
...
#define LPSPI_SR_INT_MASK_U32             ((uint32)(LPSPI_SR_DMF_W1C_U32 | LPSPI_SR_REF_W1C_U32 | LPSPI_SR_TEF_W1C_U32 | \
                                            LPSPI_SR_TCF_W1C_U32 | LPSPI_SR_FCF_W1C_U32 | LPSPI_SR_WCF_W1C_U32))
