...
*
*/
#define PWM_ENABLE_TRIGGER_API                    ([!IF "PwmConfigurationOfOptApiServices/PwmEnableTrigger"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

/**
* @brief      Switch for enabling Pwm_DisableTrigger API
*
*/
#define PWM_DISABLE_TRIGGER_API                   ([!IF "PwmConfigurationOfOptApiServices/PwmDisableTrigger"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
/**
* @brief      Switch for enabling Pwm_SetPhaseShift_TimeBase API
*
*/
#define PWM_SET_PHASE_SHIFT_TIMEBASE_API        ([!IF "PwmGeneral/PwmSetPhaseShiftTimeBaseSupported"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
[!ELSE!]
#define PWM_HW_MODULES_CFG_U8           ((uint8)1U)
[!ENDIF!]
...
[!IF "var:defined('postBuildVariant')"!][!//
    ...
    [!//
        [!CODE!][!WS4!]extern CONST(Pwm_ConfigType, PWM_CONST) Pwm_Config_[!"."!];[!IF "$variantIndex < $variantNumber"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS4!]extern CONST(Pwm_ConfigType, PWM_CONST) Pwm_Config;[!CR!][!ENDCODE!]
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDIF!]
