...
#define PWM_FLEXIO_SW_PATCH_VERSION_C                   2
/**@}*/
...
==================================================================================================*/
    ...
    /* Check if source file and CDD_Mcl.h are of the same AUTOSAR version */
    #if ((PWM_FLEXIO_AR_RELEASE_MAJOR_VERSION_C != MCL_AR_RELEASE_MAJOR_VERSION) || \
        (PWM_FLEXIO_AR_RELEASE_MINOR_VERSION_C != MCL_AR_RELEASE_MINOR_VERSION))
        #error "AUTOSAR version numbers of Pwm_FlexIO.c and CDD_Mcl.h are different."
    #endif
    
    /* Check if source file and SchM_Pwm.h are of the same Autosar version */
    #if ((PWM_FLEXIO_AR_RELEASE_MAJOR_VERSION_C != SCHM_PWM_AR_RELEASE_MAJOR_VERSION) || \
         (PWM_FLEXIO_AR_RELEASE_MINOR_VERSION_C != SCHM_PWM_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Pwm_FlexIO.c and SchM_Pwm.h are different"
    #endif
#endif
...
#define PWM_FLEXIO_TIMCMP_CMP_LOW_U32               ((uint32)0x0000FF00)

#define PWM_FLEXIO_TIMCMP_CMP_HIGH_U32              ((uint32)0x000000FF)
...
)
{
    ...
    if ((uint8)0U != (Pwm_FlexIO_au8NextChannelStatus[u8ArrayIdx] & PWM_FLEXIO_CHANNEL_CHANGE_RUNNING))
    {
           ...
           )
        {
            ...
            u32TIMCMPRegVal = (uint32)(PWM_FLEXIO_TIMCMP_CMP_LOW_U32);
        ...
        else if (((uint8)0U != Pwm_FlexIO_aPeriod[u8ArrayIdx]) && (PWM_FLEXIO_DUTY_100 == Pwm_FlexIO_au16DutyCycle[u8ArrayIdx]))
        {
            ...
            /* Set TIMCMP register value from high nibble and low nibble */
            u32TIMCMPRegVal = (uint32)(PWM_FLEXIO_TIMCMP_CMP_HIGH_U32);
...
)
{
    ...
    for (u8Counter = (uint8)0U; u8Counter < pFlexIOIpConfig->u8ChannelNumber; u8Counter++)
    {
        ...
        u32TIMCTLRegVal = REG_READ32(FLEXIO_TIMCTLn_ADDR32((uint32)nHwTimerId));
