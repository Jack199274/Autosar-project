...
* @details          Errors and exceptions that will be detected by the PWM driver
* @implements       Pwm_ErrorIds_define AUTOSAR Extension
*/
...
/**
* @brief            API service ID of Pwm_SetPhaseShift_TimeBase function
* @details          Parameters used when raising an error/exception
*/
#define PWM_SETPHASESHIFTTIMEBASE_ID           (0x36U)
...
#ifdef PWM_SET_PHASE_SHIFT_TIMEBASE_API
#if (PWM_SET_PHASE_SHIFT_TIMEBASE_API == STD_ON)
FUNC(void, PWM_CODE) Pwm_SetPhaseShift_TimeBase
(
