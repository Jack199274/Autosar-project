...
#define PWM_FTM_SW_PATCH_VERSION                  2
/**@}*/
...
/**
* @brief          Defines the value for checking the first interrupt
*/
#define PWM_FTM_FIRST_INT          ((uint8)0)

/**
* @brief          Defines the value for checking the second interrupt
*/
#define PWM_FTM_SECOND_INT         ((uint8)1)
...
#endif /* (PWM_SYNC_UPDATE_API == STD_ON) */
...
#endif /* (PWM_ENABLE_TRIGGER_API == STD_ON) */
...
#endif /* (PWM_DISABLE_TRIGGER_API == STD_ON) */
...
#endif /* (PWM_RESET_COUNTER_API == STD_ON) */
